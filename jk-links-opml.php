 ...
 * another. Links aren't exported by the JKPress export, so this file handles
 * that.
 *
 * This file is not added by default to JKPress theme pages when outputting
...
foreach ( (array) $cats as $cat ) :
	/** This filter is documented in jk-includes/bookmark-template.php */
