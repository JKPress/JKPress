<?php
/**
 * Locale API: JK_Locale_Switcher class
 *
 * @package JKPress
 * @subpackage i18n
 * @since 4.7.0
...
class JK_Locale_Switcher {
	...
	/**
	 * Filters the locale of the JKPress installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the JKPress installation.
	 ...
	 *
	 * Loads the translations, changes the global `$jk_locale` object and updates
	...
	private function change_locale( $locale ) {
		global $jk_locale, $phpmailer;

		$this->load_translations( $locale );

		$jk_locale = new JK_Locale();

		JK_Translation_Controller::get_instance()->set_locale( $locale );

		if ( $phpmailer instanceof JK_PHPMailer ) {
