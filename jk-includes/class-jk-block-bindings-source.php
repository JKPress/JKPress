<?php
/**
 * Block Bindings API: JK_Block_Bindings_Source class.
 *
 * @package JKPress
 ...
 * @access private
 *
 * @see JK_Block_Bindings_Registry
 */
final class JK_Block_Bindings_Source {
	 ...
	 * `JK_Block_Bindings_Registry::register` method or the `register_block_bindings_source` function.
	 *
	 * @since 6.5.0
	 *
