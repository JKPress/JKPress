<?php
/**
 * REST API: JK_REST_Block_Patterns_Controller class
 *
 * @package    JKPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class JK_REST_Block_Patterns_Controller extends JK_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response = array();
		$patterns = JK_Block_Patterns_Registry::get_instance()->get_all_registered();
