<?php
/**
 * REST API: JK_REST_Revisions_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JK_REST_Revisions_Controller extends JK_REST_Controller {
	...
	public function __construct( $parent_post_type ) {
		...
		$this->meta              = new JK_REST_Post_Meta_Fields( $parent_post_type );
	}
	...
	public function get_items( $request ) {
		...
		if ( jk_revisions_enabled( $parent ) ) {
		...
		$response->header( 'X-JK-Total', (int) $total_revisions );
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( ! $response || is_jk_error( $response ) ) {
			return $response;
		}
	...
	public function delete_item( $request ) {
		 ...
		 * @since 4.7.0
		 *
		 * @param JK_Post|false|null $result The revision object (if it was deleted or moved to the Trash successfully)
	 ...
	 * @param JK_Post $post    Post revision object.
