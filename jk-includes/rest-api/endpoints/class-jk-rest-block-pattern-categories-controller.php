<?php
/**
 * REST API: JK_REST_Block_Pattern_Categories_Controller class
 *
 * @package    JKPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class JK_REST_Block_Pattern_Categories_Controller extends JK_REST_Controller {
	...
	public function get_items( $request ) {
		$response   = array();
		$categories = JK_Block_Pattern_Categories_Registry::get_instance()->get_all_registered();
