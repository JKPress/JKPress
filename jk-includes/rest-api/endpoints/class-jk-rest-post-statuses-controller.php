<?php
/**
 * REST API: JK_REST_Post_Statuses_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JK_REST_Post_Statuses_Controller extends JK_REST_Controller {
	 ...
	 * @param JK_REST_Request $request Full details about the request.
	 * @return JK_REST_Response Post status data.
	 */
