 ...
 * @since 6.5.0
 */
class JK_REST_Font_Collections_Controller extends JK_REST_Controller {
	...
	public function get_items( $request ) {
		$collections_all = JK_Font_Library::get_instance()->get_font_collections();
		...
		$response->header( 'X-JK-Total', (int) $total_items );
	...
	public function get_item( $request ) {
		...
		$collection = JK_Font_Library::get_instance()->get_font_collection( $slug );

		if ( ! $collection ) {
			return new JK_Error( 'rest_font_collection_not_found', __( 'Font collection not found.' ), array( 'status' => 404 ) );
		}
	...
	* @since 6.5.0
	*
	* @param JK_Font_Collection $item    Font collection object.
	...
	*/
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( ! empty( array_intersect( $fields, $data_fields ) ) ) {
			...
			if ( is_jk_error( $collection_data ) ) {
		 ...
		 * @param JK_Font_Collection $item     The font collection object.
	 ...
	 * @since 6.5.0
	 *
	 * @param JK_Font_Collection $collection Font collection data
