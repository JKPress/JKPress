<?php
/**
 * REST API: JK_REST_Post_Types_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JK_REST_Post_Types_Controller extends JK_REST_Controller {
	 ...
	 *
	 * @param JK_Post_Type    $item    Post type object.
	 * @param JK_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		$taxonomies = jk_list_filter( get_object_taxonomies( $post_type->name, 'objects' ), array( 'show_in_rest' => true ) );
		$taxonomies = jk_list_pluck( $taxonomies, 'name' );
		 ...
		 * @param JK_Post_Type     $post_type The original post type object.
	 ...
	 * @since 6.1.0
	 *
	 * @param JK_Post_Type $post_type The post type.
