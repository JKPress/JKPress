<?php
/**
 * REST API: JK_REST_Template_Revisions_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 6.4.0
 ...
 */
class JK_REST_Template_Revisions_Controller extends JK_REST_Revisions_Controller {
	/**
	 * Parent post type.
	 *
	 * @since 6.4.0
	...
	protected function get_parent( $parent_template_id ) {
		...
		return get_post( $template->jk_id );
	}
