<?php
/**
 * REST API: JK_REST_Font_Families_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 6.5.0
 ...
 * @since 6.5.0
 */
class JK_REST_Font_Families_Controller extends JK_REST_Posts_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param JK_Post          $post     Font family post object.
		 * @param JK_REST_Request  $request  Request object.
		 */
		return apply_filters( 'rest_prepare_jk_font_family', $response, $item, $request );
	}
	...
	public function get_collection_params() {
		 ...
		 */
		return apply_filters( 'rest_jk_font_family_collection_params', $query_params );
	}
	...
	public function get_endpoint_args_for_item_schema( $method = JK_REST_Server::CREATABLE ) {
		if ( JK_REST_Server::CREATABLE === $method || JK_REST_Server::EDITABLE === $method ) {
