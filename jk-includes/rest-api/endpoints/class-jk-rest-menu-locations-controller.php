<?php
/**
 * REST API: JK_REST_Menu_Locations_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 5.9.0
 ...
 */
class JK_REST_Menu_Locations_Controller extends JK_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( ! array_key_exists( $request['location'], $registered_menus ) ) {
			return new JK_Error( 'rest_menu_location_invalid', __( 'Invalid menu location.' ), array( 'status' => 404 ) );
		}
	 ...
	 * @param JK_REST_Request $request Full details about the request.
	 * @return JK_REST_Response Menu location data.
	 */
