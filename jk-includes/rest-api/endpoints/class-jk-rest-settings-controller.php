<?php
/**
 * REST API: JK_REST_Settings_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JK_REST_Settings_Controller extends JK_REST_Controller {
	 ...
	 *
	 * @param JK_REST_Request $request Full details about the request.
	 * @return array|JK_Error Array on success, or JK_Error object on failure.
	 */
	 ...
	 *
	 * @param JK_REST_Request $request Full details about the request.
	 * @return array|JK_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_jk_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new JK_Error(
