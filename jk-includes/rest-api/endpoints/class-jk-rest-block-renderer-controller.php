<?php
/**
 * Block Renderer REST API: JK_REST_Block_Renderer_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class JK_REST_Block_Renderer_Controller extends JK_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				array(
					'methods'             => array( JK_REST_Server::READABLE, JK_REST_Server::CREATABLE ),
					...
					'args'                => array(
						...
						'attributes' => array(
							...
							'validate_callback' => static function ( $value, $request ) {
								$block = JK_Block_Type_Registry::get_instance()->get_registered( $request['name'] );
