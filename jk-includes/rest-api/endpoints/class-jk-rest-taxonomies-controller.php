<?php
/**
 * REST API: JK_REST_Taxonomies_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JK_REST_Taxonomies_Controller extends JK_REST_Controller {
	 ...
	 *
	 * @param JK_REST_Request $request Full details about the request.
	 * @return bool|JK_Error True if the request has read access for the item, otherwise false or JK_Error object.
	 */
	 ...
	 *
	 * @param JK_Taxonomy     $item    Taxonomy data.
	 * @param JK_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param JK_Taxonomy      $item     The original taxonomy object.
	 ...
	 * @since 6.1.0
	 *
	 * @param JK_Taxonomy $taxonomy The taxonomy.
