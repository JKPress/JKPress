<?php
/**
 * Synced patterns REST API: JK_REST_Blocks_Controller class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 * Patterns are stored as posts with the jk_block post type.
 *
 * @since 5.0.0
 *
 ...
 */
class JK_REST_Blocks_Controller extends JK_REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param JK_Post $post Post object that backs the block.
	 ...
	 *
	 * @since 5.0.0
	 * @since 6.3.0 Adds the `jk_pattern_sync_status` postmeta property to the top level of response.
	 *
	...
	public function filter_response_by_context( $data, $context ) {
		...
		// Add the core jk_pattern_sync_status meta as top level property to the response.
		$data['jk_pattern_sync_status'] = isset( $data['meta']['jk_pattern_sync_status'] ) ? $data['meta']['jk_pattern_sync_status'] : '';
		unset( $data['meta']['jk_pattern_sync_status'] );
		return $data;
	}
