<?php
/**
 * REST API: JK_REST_Response class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class JK_REST_Response extends JK_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = jk_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a JK_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return JK_Error|null JK_Error or null on not an errored response.
	 */
