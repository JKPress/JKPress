<?php
/**
 * REST API: JK_REST_Post_Format_Search_Handler class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class JK_REST_Post_Format_Search_Handler extends JK_REST_Search_Handler {
	...
	public function prepare_item( $id, array $fields ) {
		...
		if ( in_array( JK_REST_Search_Controller::PROP_ID, $fields, true ) ) {
			$data[ JK_REST_Search_Controller::PROP_ID ] = $id;
		}

		if ( in_array( JK_REST_Search_Controller::PROP_TITLE, $fields, true ) ) {
			$data[ JK_REST_Search_Controller::PROP_TITLE ] = get_post_format_string( $id );
		}

		if ( in_array( JK_REST_Search_Controller::PROP_URL, $fields, true ) ) {
			$data[ JK_REST_Search_Controller::PROP_URL ] = get_post_format_link( $id );
		}
