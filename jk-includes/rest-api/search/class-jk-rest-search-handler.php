<?php
/**
 * REST API: JK_REST_Search_Handler class
 *
 * @package JKPress
 * @subpackage REST_API
 * @since 5.0.0
...
abstract class JK_REST_Search_Handler {
	 ...
	 * @return array Associative array containing an `JK_REST_Search_Handler::RESULT_IDS` containing
	 *               an array of found IDs and `JK_REST_Search_Handler::RESULT_TOTAL` containing the
	 *               total count for the matching search results.
	 */
	abstract public function search_items( JK_REST_Request $request );
