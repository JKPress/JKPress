<?php
/**
 * JK_Classic_To_Block_Menu_Converter class
 *
 * @package JKPress
 * @since 6.3.0
 */
 ...
 * @access public
 */
class JK_Classic_To_Block_Menu_Converter {
	 ...
	 * @since 6.3.0
	 *
	 * @param JK_Term $menu The Menu term object of the menu to convert.
	 * @return string|JK_Error The serialized and normalized parsed blocks on success,
	 *                         an empty string when there are no menus to convert,
	 *                         or JK_Error on invalid menu.
	 */
