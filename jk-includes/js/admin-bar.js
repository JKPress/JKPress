/**
 * @output jk-includes/js/admin-bar.js
 */
/**
...
( function( document, window, navigator ) {
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		adminBarLogout = document.querySelector( '#jk-admin-bar-logout a' );
		adminBarSearchForm = document.getElementById( 'adminbarsearch' );
		shortlink = document.getElementById( 'jk-admin-bar-get-shortlink' );
	...
	function scrollToTop( event ) {
		...
		if (
			...
			event.target.id !== 'jk-admin-bar-top-secondary'
		) {
			return;
		}
