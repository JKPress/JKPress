...
/**
 * jk.media.controller.EditAttachmentMetadata
 *
 ...
 */
EditAttachmentMetadata = jk.media.controller.State.extend(/** @lends jk.media.controller.EditAttachmentMetadata.prototype */{
	defaults: {
		id:      'edit-attachment',
...
/**
 * jk.media.view.MediaFrame.Manage.Router
 *
 * A router for handling the browser history and application state.
 *
 * @memberOf jk.media.view.MediaFrame.Manage
 *
 * @class
 * @augments Backbone.Router
 */
var Router = Backbone.Router.extend(/** @lends jk.media.view.MediaFrame.Manage.Router.prototype */{
	routes: {
	...
	reset: function() {
		var frame = jk.media.frames.edit;
	...
	editItem: function( query ) {
		this.showItem( query );
		jk.media.frames.edit.content.mode( 'edit-details' );
	}
});
...
var Details = jk.media.view.Attachment.Details,
	TwoColumn;

/**
 * jk.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @memberOf jk.media.view.Attachment.Details
 *
 * @class
 * @augments jk.media.view.Attachment.Details
 * @augments jk.media.view.Attachment
 * @augments jk.media.View
 * @augments jk.Backbone.View
 * @augments Backbone.View
 */
TwoColumn = Details.extend(/** @lends jk.media.view.Attachment.Details.TwoColumn.prototype */{
	template: jk.template( 'attachment-details-two-column' ),
...
var Button = jk.media.view.Button,
	DeleteSelected = jk.media.view.DeleteSelectedButton,
	DeleteSelectedPermanently;

/**
 * jk.media.view.DeleteSelectedPermanentlyButton
 *
 ...
 *
 * @class
 * @augments jk.media.view.DeleteSelectedButton
 * @augments jk.media.view.Button
 * @augments jk.media.View
 * @augments jk.Backbone.View
 * @augments Backbone.View
 */
DeleteSelectedPermanently = DeleteSelected.extend(/** @lends jk.media.view.DeleteSelectedPermanentlyButton.prototype */{
	initialize: function() {
...
/**
 * jk.media.view.DeleteSelectedButton
 *
 ...
 * @augments Backbone.View
 */
DeleteSelected = Button.extend(/** @lends jk.media.view.DeleteSelectedButton.prototype */{
	initialize: function() {
	...
	filterChange: function( model ) {
		...
		} else if ( jk.media.view.settings.mediaTrash ) {
...
/**
 * jk.media.view.SelectModeToggleButton
 *
 * @memberOf jk.media.view
 *
 * @class
 ...
 * @augments Backbone.View
 */
SelectModeToggle = Button.extend(/** @lends jk.media.view.SelectModeToggle.prototype */{
	initialize: function() {
...
var View = jk.media.View,
	EditImage = jk.media.view.EditImage,
	Details;

/**
 * jk.media.view.EditImage.Details
 *
 * @memberOf jk.media.view.EditImage
 *
 * @class
 * @augments jk.media.view.EditImage
 * @augments jk.media.View
 * @augments jk.Backbone.View
 * @augments Backbone.View
 */
Details = EditImage.extend(/** @lends jk.media.view.EditImage.Details.prototype */{
...
var Frame = jk.media.view.Frame,
	MediaFrame = jk.media.view.MediaFrame,

	$ = jQuery,
	EditAttachments;

/**
 * jk.media.view.MediaFrame.EditAttachments
 *
 ...
 */
EditAttachments = MediaFrame.extend(/** @lends jk.media.view.MediaFrame.EditAttachments.prototype */{

	className: 'edit-attachment-frame',
	template:  jk.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new jk.media.controller.EditAttachmentMetadata({
				model:   this.model,
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new jk.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new jk.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new jk.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new jk.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
/**
 * jk.media.view.MediaFrame.Manage
 *
 ...
 * @mixes jk.media.controller.StateMachine
 */
Manage = MediaFrame.extend(/** @lends jk.media.view.MediaFrame.Manage.prototype */{
	/**
	 * @constructs
	 */
	initialize: function() {
		...
		// Store the Add New button for later reuse in jk.media.view.UploaderInline.
		...
		this.gridRouter = new jk.media.view.MediaFrame.Manage.Router();
	...
	openEditAttachmentModal: function( model ) {
		...
		if ( jk.media.frames.edit ) {
			jk.media.frames.edit.open().trigger( 'refresh', model );
		} else {
			jk.media.frames.edit = jk.media( {
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new jk.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			...
			Backbone.history.start( {
				root: window._jkMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
...
/************************************************************************/
/**
 * @output jk-includes/js/media-grid.js
 */
