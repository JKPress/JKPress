/**
 * @output jk-includes/js/customize-base.js
 */
...
(function( exports, $ ){
	 ...
	 *
	 * @memberOf jk.customize
	 * @alias jk.customize.Value
	 *
	 * @constructor
	 */
	api.Value = api.Class.extend(/** @lends jk.customize.Value.prototype */{
		/**
	 ...
	 *
	 * @memberOf jk.customize
	 * @alias jk.customize.Values
	 *
	 * @constructor
	 * @augments jk.customize.Class
	 * @mixes jk.customize.Events
	 */
	api.Values = api.Class.extend(/** @lends jk.customize.Values.prototype */{
		 ...
		 *
		 * @param {string|jk.customize.Class} item         - The item instance to add, or the ID for the instance to add.
		 *                                                   When an ID string is supplied, then itemObject must be provided.
		 * @param {jk.customize.Class}        [itemObject] - The item instance when the first argument is an ID string.
		 * @return {jk.customize.Class} The new item's instance, or an existing instance if already added.
		 */
	 ...
	 *
	 * @memberOf jk.customize
	 * @alias jk.customize.Element
	 *
	 * @constructor
	 * @augments jk.customize.Value
	 * @augments jk.customize.Class
	 */
	api.Element = api.Value.extend(/** @lends jk.customize.Element */{
	 ...
	 *
	 * @memberOf jk.customize
	 * @alias jk.customize.Messenger
	 *
	 * @constructor
	 * @augments jk.customize.Class
	 * @mixes jk.customize.Events
	 */
	api.Messenger = api.Class.extend(/** @lends jk.customize.Messenger.prototype */{
		/**
		 * Create a new Value.
		 *
	 ...
	 *
	 * @memberOf jk.customize
	 * @alias jk.customize.Notification
	 *
	 ...
	 */
	api.Notification = api.Class.extend(/** @lends jk.customize.Notification.prototype */{
		...
		render: function() {
			...
			if ( ! notification.template ) {
				notification.template = jk.template( notification.templateId );
			}
	 ...
	 * @access public
	 *
	 * @alias jk.customize.utils.parseQueryString
	 *
	...
	/**
	 * Expose the API publicly on window.jk.customize
	 *
	 * @namespace jk.customize
	 */
