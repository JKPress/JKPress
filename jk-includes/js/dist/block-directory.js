 ...
 * @return {Array} Block type items.
 */
const getNewBlockTypes = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (0,external_jk_data_namespaceObject.createSelector)(state => {
  const usedBlockTree = select(external_jk_blockEditor_namespaceObject.store).getBlocks();
  const installedBlockTypes = getInstalledBlockTypes(state);
  return installedBlockTypes.filter(blockType => hasBlockType(blockType, usedBlockTree));
}, state => [getInstalledBlockTypes(state), select(external_jk_blockEditor_namespaceObject.store).getBlocks()]));
 ...
 * @return {Array} Block type items.
 */
const getUnusedBlockTypes = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (0,external_jk_data_namespaceObject.createSelector)(state => {
  const usedBlockTree = select(external_jk_blockEditor_namespaceObject.store).getBlocks();
  const installedBlockTypes = getInstalledBlockTypes(state);
  return installedBlockTypes.filter(blockType => !hasBlockType(blockType, usedBlockTree));
}, state => [getInstalledBlockTypes(state), select(external_jk_blockEditor_namespaceObject.store).getBlocks()]));
...
function getPluginUrl(block) {
  ...
  const link = block.links['jk:plugin'] || block.links.self;
  if (link && link.length) {
    return link[0].href;
  }
  return false;
...
const installBlockType = block => async ({
  ...
  try {
    ...
    // If we have a jk:plugin link, the plugin is installed but inactive.
    ...
    await external_jk_apiFetch_default()({
      path: (0,external_jk_url_namespaceObject.addQueryArgs)(`/jk/v2/block-types/${name}`, {
    ...
    await loadAssets();
    const registeredBlocks = registry.select(external_jk_blocks_namespaceObject.store).getBlockTypes();
    if (!registeredBlocks.some(i => i.name === name)) {
      throw new Error((0,external_jk_i18n_namespaceObject.__)('Error registering block. Try reloading the page.'));
    }
    registry.dispatch(external_jk_notices_namespaceObject.store).createInfoNotice((0,external_jk_i18n_namespaceObject.sprintf)(
    // translators: %s is the block title.
    (0,external_jk_i18n_namespaceObject.__)('Block %s installed and added.'), block.title), {
      speak: true,
      type: 'snackbar'
    });
    success = true;
  } catch (error) {
    let message = error.message || (0,external_jk_i18n_namespaceObject.__)('An error occurred.');
    ...
    const fatalAPIErrors = {
      folder_exists: (0,external_jk_i18n_namespaceObject.__)('This block is already installed. Try reloading the page.'),
      unable_to_connect_to_filesystem: (0,external_jk_i18n_namespaceObject.__)('Error installing block. You can reload the page and try again.')
    };
    ...
    registry.dispatch(external_jk_notices_namespaceObject.store).createErrorNotice(message, {
      speak: true,
      isDismissible: true
    });
  }
...
const uninstallBlockType = block => async ({
  ...
  try {
    ...
    registry.dispatch(external_jk_notices_namespaceObject.store).createErrorNotice(error.message || (0,external_jk_i18n_namespaceObject.__)('An error occurred.'));
  }
};
...
const resolvers_getDownloadableBlocks = filterValue => async ({
  ...
  try {
    ...
    const results = await external_jk_apiFetch_default()({
      path: `jk/v2/block-directory/search?term=${filterValue}`
    });
...
function AutoBlockUninstaller() {
  ...
  const shouldRemoveBlockTypes = (0,external_jk_data_namespaceObject.useSelect)(select => {
    const {
      isAutosavingPost,
      isSavingPost
  ...
  const unusedBlockTypes = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).getUnusedBlockTypes(), []);
  (0,external_jk_element_namespaceObject.useEffect)(() => {
    if (shouldRemoveBlockTypes && unusedBlockTypes.length) {
      unusedBlockTypes.forEach(blockType => {
        uninstallBlockType(blockType);
        (0,external_jk_blocks_namespaceObject.unregisterBlockType)(blockType.name);
      });
    }
...
const starHalf = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.Path, {
...
function Stars({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("span", {
    "aria-label": (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: number of stars. */
    (0,external_jk_i18n_namespaceObject.__)('%s out of 5 stars'), stars),
    children: [Array.from({
...
function DownloadableBlockIcon({
  ...
  return icon.match(/\.(jpeg|jpg|gif|png|svg)(?:\?.*)?$/) !== null ? /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("img", {
    ...
    src: icon,
    alt: ""
  }) : /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.BlockIcon, {
    className: className,
    icon: icon,
    showColors: true
  });
...
const DownloadableBlockNotice = ({
  ...
  const errorNotice = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).getErrorNoticeForBlock(block.id), [block]);
  if (!errorNotice) {
    return null;
  }
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [errorNotice.message, errorNotice.isFatal ? ' ' + (0,external_jk_i18n_namespaceObject.__)('Try reloading the page.') : null]
    })
  });
};
...
function getDownloadableBlockLabel({
  ...
  if (!isInstalled && hasNotice) {
    ...
    return (0,external_jk_i18n_namespaceObject.sprintf)('Retry installing %s.', (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title));
  }
  if (isInstalled) {
    /* translators: %s: block title */
    return (0,external_jk_i18n_namespaceObject.sprintf)('Add %s.', (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title));
  }
  if (isInstalling) {
    /* translators: %s: block title */
    return (0,external_jk_i18n_namespaceObject.sprintf)('Installing %s.', (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title));
  }

  // No ratings yet, just use the title.
  if (ratingCount < 1) {
    /* translators: %s: block title */
    return (0,external_jk_i18n_namespaceObject.sprintf)('Install %s.', (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title));
  }
  return (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: 1: block title, 2: average rating, 3: total ratings count. */
  (0,external_jk_i18n_namespaceObject._n)('Install %1$s. %2$s stars with %3$s review.', 'Install %1$s. %2$s stars with %3$s reviews.', ratingCount), (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title), stars, ratingCount);
}
function DownloadableBlockListItem({
  ...
  const isInstalled = !!(0,external_jk_blocks_namespaceObject.getBlockType)(item.name);
  const {
    hasNotice,
    isInstalling,
    isInstallable
  ...
  let statusText = '';
  if (isInstalled) {
    statusText = (0,external_jk_i18n_namespaceObject.__)('Installed!');
  } else if (isInstalling) {
    statusText = (0,external_jk_i18n_namespaceObject.__)('Installing…');
  }
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Tooltip, {
    placement: "top",
    text: itemLabel,
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_jk_components_namespaceObject.Composite.Item, {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(downloadable_block_icon, {
          ...
          children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Spinner, {})
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
          ...
          children: (0,external_jk_element_namespaceObject.createInterpolateElement)((0,external_jk_i18n_namespaceObject.sprintf)( /* translators: 1: block title. 2: author name. */
          (0,external_jk_i18n_namespaceObject.__)('%1$s <span>by %2$s</span>'), (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(title), author), {
          ...
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
            ...
            children: !!statusText ? statusText : (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(description)
          }), isInstallable && !(isInstalled || isInstalling) && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.VisuallyHidden, {
            children: (0,external_jk_i18n_namespaceObject.__)('Install block')
          })]
        })]
      })]
    })
...
function DownloadableBlocksList({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Composite, {
    role: "listbox",
    className: "block-directory-downloadable-blocks-list",
    "aria-label": (0,external_jk_i18n_namespaceObject.__)('Blocks available for install'),
    children: items.map(item => {
      return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(downloadable_block_list_item, {
        onClick: () => {
          ...
          if ((0,external_jk_blocks_namespaceObject.getBlockType)(item.name)) {
            onSelect(item);
          } else {
...
function DownloadableBlocksInserterPanel({
  ...
  (0,external_jk_element_namespaceObject.useEffect)(() => {
    (0,external_jk_a11y_namespaceObject.speak)((0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %d: number of available blocks. */
    (0,external_jk_i18n_namespaceObject._n)('%d additional block is available to install.', '%d additional blocks are available to install.', count), count));
  }, [count]);
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [!hasLocalBlocks && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
      ...
      children: (0,external_jk_i18n_namespaceObject.__)('No results available from your installed blocks.')
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h2", {
          ...
          children: (0,external_jk_i18n_namespaceObject.__)('Available to install')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
          className: "block-directory-downloadable-blocks-panel__description",
          children: (0,external_jk_i18n_namespaceObject.__)('Select a block to install and add it to your post.')
        })]
      }), children]
    })]
  });
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(icon, {
        ...
        children: (0,external_jk_i18n_namespaceObject.__)('No results found.')
      })]
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      className: "block-editor-inserter__tips",
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_jk_components_namespaceObject.Tip, {
        children: [(0,external_jk_i18n_namespaceObject.__)('Interested in creating your own block?'), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("br", {}), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_jk_components_namespaceObject.ExternalLink, {
          href: "https://developer.wordpress.org/block-editor/",
          children: [(0,external_jk_i18n_namespaceObject.__)('Get started here'), "."]
        })]
      })
    })]
  });
...
const EMPTY_ARRAY = [];
const useDownloadableBlocks = filterValue => (0,external_jk_data_namespaceObject.useSelect)(select => {
  const {
    getDownloadableBlocks,
    isRequestingDownloadableBlocks,
    getInstalledBlockTypes
  } = select(store);
  const hasPermission = select(external_jk_coreData_namespaceObject.store).canUser('read', 'block-directory/search');
  ...
  if (hasPermission) {
    ...
    const installableBlocks = downloadableBlocks.filter(({
      ...
      const isPreviouslyInstalled = (0,external_jk_blocks_namespaceObject.getBlockType)(name);
...
function InserterMenuDownloadableBlocksPanel() {
  const [debouncedFilterValue, setFilterValue] = (0,external_jk_element_namespaceObject.useState)('');
  const debouncedSetFilterValue = (0,external_jk_compose_namespaceObject.debounce)(setFilterValue, 400);
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.__unstableInserterMenuExtension, {
    children: ({
      onSelect,
      onHover,
      filterValue,
    ...
    children: items.map(({
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(downloadable_block_icon, {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
          ...
          children: (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: Name of the block author. */
          (0,external_jk_i18n_namespaceObject.__)('By %s'), author)
        })]
      })]
    }, id))
  });
...
function InstalledBlocksPrePublishPanel() {
  const newBlockTypes = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).getNewBlockTypes(), []);
  if (!newBlockTypes.length) {
    return null;
  }
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_jk_editor_namespaceObject.PluginPrePublishPanel, {
    icon: block_default,
    title: (0,external_jk_i18n_namespaceObject.sprintf)(
    // translators: %d: number of blocks (number).
    (0,external_jk_i18n_namespaceObject._n)('Added: %d block', 'Added: %d blocks', newBlockTypes.length), newBlockTypes.length),
    initialOpen: true,
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
      className: "installed-blocks-pre-publish-panel__copy",
      children: (0,external_jk_i18n_namespaceObject._n)('The following block has been added to your site.', 'The following blocks have been added to your site.', newBlockTypes.length)
...
function InstallButton({
  ...
  const isInstallingBlock = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).isInstalling(block.id), [block.id]);
  const {
    installBlockType
  } = (0,external_jk_data_namespaceObject.useDispatch)(store);
  const {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Button, {
    ...
    onClick: () => installBlockType(block).then(success => {
      if (success) {
        const blockType = (0,external_jk_blocks_namespaceObject.getBlockType)(block.name);
        const [originalBlock] = (0,external_jk_blocks_namespaceObject.parse)(attributes.originalContent);
        if (originalBlock && blockType) {
          replaceBlock(clientId, (0,external_jk_blocks_namespaceObject.createBlock)(blockType.name, originalBlock.attributes, originalBlock.innerBlocks));
        }
      }
    }),
    accessibleWhenDisabled: true,
    ...
    variant: "primary",
    children: (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: block name */
    (0,external_jk_i18n_namespaceObject.__)('Install %s'), block.title)
  });
}
...
const getInstallMissing = OriginalComponent => props => {
  ...
  const {
    ...
    return {
      hasPermission: select(external_jk_coreData_namespaceObject.store).canUser('read', 'block-directory/search'),
...
const ModifiedWarning = ({
  ...
  const convertToHTML = () => {
    replaceBlock(props.clientId, (0,external_jk_blocks_namespaceObject.createBlock)('core/html', {
      content: originalUndelimitedContent
    }));
  };
  const hasContent = !!originalUndelimitedContent;
  const hasHTMLBlock = (0,external_jk_data_namespaceObject.useSelect)(select => {
    const {
      canInsertBlockType,
  ...
  let messageHTML = (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: block name */
  (0,external_jk_i18n_namespaceObject.__)('Your site doesn’t include support for the %s block. You can try installing the block or remove it entirely.'), originalBlock.title || originalName);
  ...
  if (hasContent && hasHTMLBlock) {
    messageHTML = (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: block name */
    (0,external_jk_i18n_namespaceObject.__)('Your site doesn’t include support for the %s block. You can try installing the block, convert it to a Custom HTML block, or remove it entirely.'), originalBlock.title || originalName);
    actions.push( /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Button, {
      __next40pxDefaultSize: true,
      onClick: convertToHTML,
      variant: "tertiary",
      children: (0,external_jk_i18n_namespaceObject.__)('Keep as HTML')
    }, "convert"));
  }
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...(0,external_jk_blockEditor_namespaceObject.useBlockProps)(),
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.Warning, {
      actions: actions,
      children: messageHTML
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_element_namespaceObject.RawHTML, {
...
(0,external_jk_plugins_namespaceObject.registerPlugin)('block-directory', {
  render() {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
...
(0,external_jk_hooks_namespaceObject.addFilter)('blocks.registerBlockType', 'block-directory/fallback', (settings, name) => {
...
(window.jk = window.jk || {}).blockDirectory = __webpack_exports__;
/******/ })()
;