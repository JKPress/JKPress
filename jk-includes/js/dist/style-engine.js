...
/**
 * Returns a JKPress CSS custom var value from incoming style preset value,
 * if one is detected.
 *
 ...
 * Example:
 *
 * `getCSSValueFromRawStyle( 'var:preset|color|heavenlyBlue' )` // returns 'var(--jk--preset--color--heavenly-blue)'
 *
...
(window.jk = window.jk || {}).styleEngine = __webpack_exports__;
/******/ })()
;