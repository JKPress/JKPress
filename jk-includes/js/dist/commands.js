...
const search = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
...
const reducer = (0,external_jk_data_namespaceObject.combineReducers)({
  commands,
  commandLoaders,
  isOpen,
  context
...
/** @typedef {import('@wordpress/keycodes').JKKeycodeModifier} JKKeycodeModifier */

/**
 * Configuration of a registered keyboard shortcut.
 *
 * @typedef {Object} JKCommandConfig
 *
...
/**
 * @typedef {(search: string) => JKCommandConfig[]} JKCommandLoaderHook hoo
 */

/**
 * Command loader config.
 *
 * @typedef {Object} JKCommandLoaderConfig
 *
 * @property {string}              name     Command loader name.
 * @property {string=}             context  Command loader context.
 * @property {JKCommandLoaderHook} hook     Command loader hook.
 ...
 *
 * @param {JKCommandConfig} config Command config.
 *
 ...
 *
 * @param {JKCommandLoaderConfig} config Command loader config.
 *
 * @return {Object} action.
 */
 ...
 *
 * @return {import('./actions').JKCommandConfig[]} The list of registered commands.
 */
const getCommands = (0,external_jk_data_namespaceObject.createSelector)((state, contextual = false) => Object.values(state.commands).filter(command => {
 ...
 *
 * @return {import('./actions').JKCommandLoaderConfig[]} The list of registered command loaders.
 */
const getCommandLoaders = (0,external_jk_data_namespaceObject.createSelector)((state, contextual = false) => Object.values(state.commandLoaders).filter(loader => {
...
const {
  lock,
  unlock
} = (0,external_jk_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of JKPress.', '@wordpress/commands');
...
const inputLabel = (0,external_jk_i18n_namespaceObject.__)('Search commands and settings');
      ...
      return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(He.Item, {
        ...
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_jk_components_namespaceObject.__experimentalHStack, {
          ...
          children: [command.icon && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(icon, {
            ...
            children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.TextHighlight, {
              text: command.label,
              highlight: search
            })
          })]
...
function CommandMenuLoaderWrapper({
  ...
  const currentLoaderRef = (0,external_jk_element_namespaceObject.useRef)(hook);
  const [key, setKey] = (0,external_jk_element_namespaceObject.useState)(0);
  (0,external_jk_element_namespaceObject.useEffect)(() => {
...
function CommandInput({
  ...
  const commandMenuInput = (0,external_jk_element_namespaceObject.useRef)();
  const _value = dist_D(state => state.value);
  const selectedItemId = (0,external_jk_element_namespaceObject.useMemo)(() => {
...
function CommandMenu() {
  ...
  const isOpen = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).isOpen(), []);
  const {
    open,
    close
  } = (0,external_jk_data_namespaceObject.useDispatch)(store);
  const [loaders, setLoaders] = (0,external_jk_element_namespaceObject.useState)({});
  (0,external_jk_element_namespaceObject.useEffect)(() => {
    registerShortcut({
      name: 'core/commands',
      category: 'global',
      description: (0,external_jk_i18n_namespaceObject.__)('Open the command palette.'),
      keyCombination: {
        modifier: 'primary',
        character: 'k'
      }
  ...
  (0,external_jk_keyboardShortcuts_namespaceObject.useShortcut)('core/commands', /** @type {import('react').KeyboardEventHandler} */
  event => {
  ...
  const setLoader = (0,external_jk_element_namespaceObject.useCallback)((name, value) => setLoaders(current => ({
    ...current,
    [name]: value
  })), []);
  const closeAndReset = () => {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Modal, {
    ...
    contentLabel: (0,external_jk_i18n_namespaceObject.__)('Command palette'),
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      ...
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(He, {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
          ...
          label: (0,external_jk_i18n_namespaceObject.__)('Command suggestions'),
...
function useCommandContext(context) {
  const {
    getContext
  } = (0,external_jk_data_namespaceObject.useSelect)(store);
  const initialContext = (0,external_jk_element_namespaceObject.useRef)(getContext());
  const {
    setContext
 ...
 *
 * @param {import('../store/actions').JKCommandConfig} command command config.
 *
 * @example
 * ```js
...
function useCommand(command) {
  ...
  const currentCallbackRef = (0,external_jk_element_namespaceObject.useRef)(command.callback);
  (0,external_jk_element_namespaceObject.useEffect)(() => {
 ...
 *
 * @param {import('../store/actions').JKCommandLoaderConfig} loader command loader config.
 *
 * @example
 * ```js
...
(window.jk = window.jk || {}).commands = __webpack_exports__;
/******/ })()
;