...
const {
  ...
  callbacks: {
    setOverlayStyles() {
      ...
      state.overlayStyles = `
				:root {
					--jk--lightbox-initial-top-position: ${screenPosY}px;
					--jk--lightbox-initial-left-position: ${screenPosX}px;
					--jk--lightbox-container-width: ${containerWidth + 1}px;
					--jk--lightbox-container-height: ${containerHeight + 1}px;
					--jk--lightbox-image-width: ${lightboxImgWidth}px;
					--jk--lightbox-image-height: ${lightboxImgHeight}px;
					--jk--lightbox-scale: ${containerScale};
					--jk--lightbox-scrollbar-width: ${window.innerWidth - document.documentElement.clientWidth}px;
				}
			`;
    },
    setButtonStyles() {
