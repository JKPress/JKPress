...
module.exports = window["jk"]["isShallowEqual"];
...
async function defaultProcessor(requests) {
  if (maxItems === null) {
    const preflightResponse = await external_jk_apiFetch_default()({
      path: '/batch/v1',
      method: 'OPTIONS'
    });
  ...
  for (const batchRequests of chunk(requests, maxItems)) {
    const batchResponse = await external_jk_apiFetch_default()({
      path: '/batch/v1',
      method: 'POST',
      data: {
 ...
 * API request using the JKPress batch processing API (/v1/batch).
 *
 * ```
 ...
 *
 * @deprecated since JK 5.9, this is not useful anymore, use the selector directly.
 *
 * @return {Object} Action object.
 */
function receiveThemeSupports() {
  external_jk_deprecated_default()("jk.data.dispatch( 'core' ).receiveThemeSupports", {
    since: '5.9'
  });
  return {
    type: 'DO_NOTHING'
 ...
 * Ignored from documentation as it's internal to the data store.
 *
 * @deprecated since JKPress 6.5.0. Callers should use `dispatch( 'core' ).receiveRevision` instead.
 *
 * @ignore
 *
...
function receiveThemeGlobalStyleRevisions(currentId, revisions) {
  external_jk_deprecated_default()("jk.data.dispatch( 'core' ).receiveThemeGlobalStyleRevisions()", {
    since: '6.5.0',
    alternative: "jk.data.dispatch( 'core' ).receiveRevisions"
  });
  return {
...
const deleteEntityRecord = (kind, name, recordId, query, {
  __unstableFetch = (external_jk_apiFetch_default()),
  throwOnError = false
} = {}) => async ({
  dispatch
}) => {
  ...
  try {
    ...
    try {
      ...
      if (query) {
        path = (0,external_jk_url_namespaceObject.addQueryArgs)(path, query);
      }
 ...
 *
 * @deprecated since JK 5.9, use receiveUserPermission instead.
 *
...
function receiveUploadPermissions(hasUploadPermissions) {
  external_jk_deprecated_default()("jk.data.dispatch( 'core' ).receiveUploadPermissions", {
    since: '5.9',
...
const rootEntitiesConfig = [{
  label: (0,external_jk_i18n_namespaceObject.__)('Base'),
  kind: 'root',
  name: '__unstableBase',
  baseURL: '/',
  baseURLParams: {
  ...
  syncConfig: {
    fetch: async () => {
      return external_jk_apiFetch_default()({
        path: '/'
      });
    },
  ...
  label: (0,external_jk_i18n_namespaceObject.__)('Post Type'),
  name: 'postType',
  kind: 'root',
  key: 'slug',
  baseURL: '/jk/v2/types',
  ...
  syncConfig: {
    fetch: async id => {
      return external_jk_apiFetch_default()({
        path: `/jk/v2/types/${id}?context=edit`
      });
    },
    applyChangesToDoc: (doc, changes) => {
      const document = doc.getMap('document');
  ...
  plural: 'mediaItems',
  label: (0,external_jk_i18n_namespaceObject.__)('Media'),
  ...
  kind: 'root',
  key: 'slug',
  baseURL: '/jk/v2/taxonomies',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'taxonomies',
  label: (0,external_jk_i18n_namespaceObject.__)('Taxonomy')
}, {
  name: 'sidebar',
  kind: 'root',
  baseURL: '/jk/v2/sidebars',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'sidebars',
  ...
  label: (0,external_jk_i18n_namespaceObject.__)('Widget areas')
}, {
  name: 'widget',
  kind: 'root',
  baseURL: '/jk/v2/widgets',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'widgets',
  ...
  label: (0,external_jk_i18n_namespaceObject.__)('Widgets')
}, {
  name: 'widgetType',
  kind: 'root',
  baseURL: '/jk/v2/widget-types',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'widgetTypes',
  label: (0,external_jk_i18n_namespaceObject.__)('Widget types')
}, {
  label: (0,external_jk_i18n_namespaceObject.__)('User'),
  name: 'user',
  kind: 'root',
  baseURL: '/jk/v2/users',
  baseURLParams: {
  ...
  name: 'comment',
  kind: 'root',
  baseURL: '/jk/v2/comments',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'comments',
  label: (0,external_jk_i18n_namespaceObject.__)('Comment')
}, {
  name: 'menu',
  kind: 'root',
  baseURL: '/jk/v2/menus',
  ...
  plural: 'menus',
  label: (0,external_jk_i18n_namespaceObject.__)('Menu')
}, {
  name: 'menuItem',
  kind: 'root',
  baseURL: '/jk/v2/menu-items',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'menuItems',
  label: (0,external_jk_i18n_namespaceObject.__)('Menu Item'),
  rawAttributes: ['title']
}, {
  name: 'menuLocation',
  kind: 'root',
  baseURL: '/jk/v2/menu-locations',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'menuLocations',
  label: (0,external_jk_i18n_namespaceObject.__)('Menu Location'),
  key: 'name'
}, {
  label: (0,external_jk_i18n_namespaceObject.__)('Global Styles'),
  name: 'globalStyles',
  kind: 'root',
  baseURL: '/jk/v2/global-styles',
  baseURLParams: {
    context: 'edit'
  },
  ...
  getRevisionsUrl: (parentId, revisionId) => `/jk/v2/global-styles/${parentId}/revisions${revisionId ? '/' + revisionId : ''}`,
  supportsPagination: true
}, {
  label: (0,external_jk_i18n_namespaceObject.__)('Themes'),
  name: 'theme',
  kind: 'root',
  baseURL: '/jk/v2/themes',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'themes',
  ...
  label: (0,external_jk_i18n_namespaceObject.__)('Plugins'),
  name: 'plugin',
  kind: 'root',
  baseURL: '/jk/v2/plugins',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'plugins',
  ...
  label: (0,external_jk_i18n_namespaceObject.__)('Status'),
  name: 'status',
  kind: 'root',
  baseURL: '/jk/v2/statuses',
  baseURLParams: {
    context: 'edit'
  },
  plural: 'statuses',
...
async function loadPostTypeEntities() {
  const postTypes = await external_jk_apiFetch_default()({
    path: '/jk/v2/types?context=view'
  });
  return Object.entries(postTypes !== null && postTypes !== void 0 ? postTypes : {}).map(([name, postType]) => {
    var _postType$rest_namesp;
    const isTemplate = ['jk_template', 'jk_template_part'].includes(name);
    const namespace = (_postType$rest_namesp = postType?.rest_namespace) !== null && _postType$rest_namesp !== void 0 ? _postType$rest_namesp : 'jk/v2';
    return {
      kind: 'postType',
      ...
      revisionKey: isTemplate ? 'jk_id' : DEFAULT_ENTITY_KEY
    };
  });
}
...
async function loadTaxonomyEntities() {
  const taxonomies = await external_jk_apiFetch_default()({
    path: '/jk/v2/taxonomies?context=view'
  });
  return Object.entries(taxonomies !== null && taxonomies !== void 0 ? taxonomies : {}).map(([name, taxonomy]) => {
    var _taxonomy$rest_namesp;
    const namespace = (_taxonomy$rest_namesp = taxonomy?.rest_namespace) !== null && _taxonomy$rest_namesp !== void 0 ? _taxonomy$rest_namesp : 'jk/v2';
    return {
      kind: 'taxonomy',
...
async function loadSiteEntity() {
  ...
  const entity = {
    label: (0,external_jk_i18n_namespaceObject.__)('Site'),
    name: 'site',
    kind: 'root',
    baseURL: '/jk/v2/settings',
    syncConfig: {
      fetch: async () => {
        return external_jk_apiFetch_default()({
          path: '/jk/v2/settings'
  ...
  const site = await external_jk_apiFetch_default()({
    path: entity.baseURL,
    method: 'OPTIONS'
  });
  const labels = {};
 ...
 *
 * @typedef {Object} JKQueriedDataQueryParts
 *
 ...
 * @param {Object} query Optional query object.
 *
 * @return {JKQueriedDataQueryParts} Query parts.
 */
function getQueryParts(query) {
  /**
   * @type {JKQueriedDataQueryParts}
   */
  const parts = {
    stableKey: '',
    page: 1,
  ...
  for (let i = 0; i < keys.length; i++) {
    ...
    switch (key) {
      ...
      default:
        ...
        parts.stableKey += (parts.stableKey ? '&' : '') + (0,external_jk_url_namespaceObject.addQueryArgs)('', {
          [key]: value
        }).slice(1);
    }
  }
 ...
 * @return {Object} Next state.
 */
const receiveQueries = (0,external_jk_compose_namespaceObject.compose)([
...
function entity(entityConfig) {
  return (0,external_jk_compose_namespaceObject.compose)([withMultiEntityRecordEdits,
  // Limit to matching action type so we don't attempt to replace action on
  // an unhandled action.
  ...
  })])((0,external_jk_data_namespaceObject.combineReducers)({
    queriedData: reducer,
    edits: (state = {}, action) => {
...
const entities = (state = {}, action) => {
  ...
  if (!entitiesDataReducer || newConfig !== state.config) {
    ...
    entitiesDataReducer = (0,external_jk_data_namespaceObject.combineReducers)(Object.entries(entitiesByKind).reduce((memo, [kind, subEntities]) => {
      const kindReducer = (0,external_jk_data_namespaceObject.combineReducers)(subEntities.reduce((kindMemo, entityConfig) => ({
        ...kindMemo,
...
/* harmony default export */ const build_module_reducer = ((0,external_jk_data_namespaceObject.combineReducers)({
  terms,
  users,
  currentTheme,
 ...
 * @return {?Array} Query items.
 */
const getQueriedItems = (0,external_jk_data_namespaceObject.createSelector)((state, query = {}) => {
...
// See https://github.com/JKPress/gutenberg/pull/40025#discussion_r865410589 for more context.
 ...
 */
const isRequestingEmbedPreview = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (state, url) => {
...
function getAuthors(state, query) {
  external_jk_deprecated_default()("select( 'core' ).getAuthors()", {
    since: '5.9',
    alternative: "select( 'core' ).getUsers({ who: 'authors' })"
  });
  const path = (0,external_jk_url_namespaceObject.addQueryArgs)('/jk/v2/users/?who=authors&per_page=100', query);
 ...
 * @return Users list.
 */
const getUserQueryResults = (0,external_jk_data_namespaceObject.createSelector)((state, queryID) => {
 ...
 *
 * @deprecated since JKPress 6.0. Use getEntitiesConfig instead
 * @param      state Data state.
...
function getEntitiesByKind(state, kind) {
  external_jk_deprecated_default()("jk.data.select( 'core' ).getEntitiesByKind()", {
    since: '6.0',
    alternative: "jk.data.select( 'core' ).getEntitiesConfig()"
  });
 ...
 * @return Array of entities with config matching kind.
 */
const getEntitiesConfig = (0,external_jk_data_namespaceObject.createSelector)((state, kind) => state.entities.config.filter(entity => entity.kind === kind), /* eslint-disable @typescript-eslint/no-unused-vars */
(state, kind) => state.entities.config
/* eslint-enable @typescript-eslint/no-unused-vars */);
/**
 * Returns the entity config given its kind and name.
 *
 * @deprecated since JKPress 6.0. Use getEntityConfig instead
 * @param      state Data state.
 * @param      kind  Entity kind.
...
function getEntity(state, kind, name) {
  external_jk_deprecated_default()("jk.data.select( 'core' ).getEntity()", {
    since: '6.0',
    alternative: "jk.data.select( 'core' ).getEntityConfig()"
  });
 ...
 *
 * See https://github.com/JKPress/gutenberg/pull/41578 for more details.
 */
 ...
 * @return Record.
 */
const getEntityRecord = (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, key, query) => {
  var _query$context;
 ...
 */
const getRawEntityRecord = (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, key) => {
 ...
 *
 * @see GetEntityRecord
 * @see https://github.com/JKPress/gutenberg/pull/41578
 */
 ...
 */
const __experimentalGetDirtyEntityRecords = (0,external_jk_data_namespaceObject.createSelector)(state => {
  const {
    entities: {
      records
    }
 ...
 */
const __experimentalGetEntitiesBeingSaved = (0,external_jk_data_namespaceObject.createSelector)(state => {
  const {
    entities: {
      records
    }
 ...
 */
const getEntityRecordNonTransientEdits = (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, recordId) => {
  const {
    transientEdits
 ...
 */
const getEditedEntityRecord = (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, recordId) => {
...
function getUndoEdit(state) {
  external_jk_deprecated_default()("select( 'core' ).getUndoEdit()", {
    since: '6.3'
  });
  return undefined;
}
...
function getRedoEdit(state) {
  external_jk_deprecated_default()("select( 'core' ).getRedoEdit()", {
    since: '6.3'
  });
  return undefined;
}
 ...
 *
 * JKPress can be configured to return a simple link to a URL if it is not embeddable.
...
function canUserEditEntityRecord(state, kind, name, recordId) {
  external_jk_deprecated_default()(`jk.data.select( 'core' ).canUserEditEntityRecord()`, {
    since: '6.7',
    alternative: `jk.data.select( 'core' ).canUser( 'update', { kind, name, id } )`
  });
 ...
 */
const hasFetchedAutosaves = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (state, postType, postId) => {
...
function __experimentalGetTemplateForLink(state, link) {
  const records = getEntityRecords(state, 'postType', 'jk_template', {
    'find-template': link
  });
  if (records?.length) {
    return getEditedEntityRecord(state, 'postType', 'jk_template', records[0].id);
  }
  return null;
}
 ...
 *
 * @deprecated since JKPress 6.5.0. Callers should use `select( 'core' ).getRevisions( 'root', 'globalStyles', ${ recordKey } )` instead, where `recordKey` is the id of the global styles parent post.
 *
 * @param      state Data state.
 *
...
function getCurrentThemeGlobalStylesRevisions(state) {
  external_jk_deprecated_default()("select( 'core' ).getCurrentThemeGlobalStylesRevisions()", {
    since: '6.5.0',
 ...
 * @return Record.
 */
const getRevision = (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, recordKey, revisionKey, query) => {
  var _query$context5;
...
const getBlockPatternsForPostType = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (0,external_jk_data_namespaceObject.createSelector)((state, postType) => select(STORE_NAME).getBlockPatterns().filter(({
  postTypes
 ...
 */
const getEntityRecordsPermissions = (0,external_jk_data_namespaceObject.createRegistrySelector)(select => (0,external_jk_data_namespaceObject.createSelector)((state, kind, name, ids) => {
...
/**
 * Fetches link suggestions from the JKPress API.
 *
 * JKPress does not support searching multiple tables at once, e.g. posts and terms, so we
...
async function fetchLinkSuggestions(search, searchOptions = {}, editorSettings = {}) {
  ...
  const queries = [];
  if (!type || type === 'post') {
    queries.push(external_jk_apiFetch_default()({
      path: (0,external_jk_url_namespaceObject.addQueryArgs)('/jk/v2/search', {
        search,
        page,
        per_page: perPage,
        type: 'post',
      ...
      return results.map(result => {
        return {
          id: result.id,
          url: result.url,
          title: (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(result.title || '') || (0,external_jk_i18n_namespaceObject.__)('(no title)'),
  ...
  if (!type || type === 'attachment') {
    queries.push(external_jk_apiFetch_default()({
      path: (0,external_jk_url_namespaceObject.addQueryArgs)('/jk/v2/media', {
        search,
        page,
        per_page: perPage
      })
      ...
      return results.map(result => {
        return {
          ...
          title: (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(result.title.rendered || '') || (0,external_jk_i18n_namespaceObject.__)('(no title)'),
          type: result.type,
          kind: 'media'
        };
      });
 ...
 * ) => fetchUrlData( url );
 * ```
 * @return {Promise< JKRemoteUrlData[] >} Remote URL data.
 */
const fetchUrlData = async (url, options = {}) => {
  const endpoint = '/jk-block-editor/v1/url-details';
  const args = {
    url: (0,external_jk_url_namespaceObject.prependHTTP)(url)
  };
  if (!(0,external_jk_url_namespaceObject.isURL)(url)) {
    return Promise.reject(`${url} is not a valid URL.`);
  }

  // Test for "http" based URL as it is possible for valid
  // yet unusable URLs such as `tel:123456` to be passed.
  const protocol = (0,external_jk_url_namespaceObject.getProtocol)(url);
  if (!protocol || !(0,external_jk_url_namespaceObject.isValidProtocol)(protocol) || !protocol.startsWith('http') || !/^https?:\/\/[^\/\s]/i.test(url)) {
  ...
  return external_jk_apiFetch_default()({
    path: (0,external_jk_url_namespaceObject.addQueryArgs)(endpoint, args),
    ...options
  }).then(res => {
    CACHE.set(url, res);
    return res;
...
async function fetchBlockPatterns() {
  const restPatterns = await external_jk_apiFetch_default()({
    path: '/jk/v2/block-patterns/patterns'
  });
  if (!restPatterns) {
    return [];
  }
...
const resolvers_getAuthors = query => async ({
  ...
  const path = (0,external_jk_url_namespaceObject.addQueryArgs)('/jk/v2/users/?who=authors&per_page=100', query);
  const users = await external_jk_apiFetch_default()({
    path
  });
...
const resolvers_getCurrentUser = () => async ({
  ...
  const currentUser = await external_jk_apiFetch_default()({
    path: '/jk/v2/users/me'
  });
...
const resolvers_getEntityRecord = (kind, name, key = '', query) => async ({
  ...
  try {
    ...
    if (window.__experimentalEnableSync && entityConfig.syncConfig && !query) {
      ...
      const path = (0,external_jk_url_namespaceObject.addQueryArgs)(entityConfig.baseURL + (key ? '/' + key : ''), {
      ...
      const response = await external_jk_apiFetch_default()({
        path,
        parse: false
      });
...
const resolvers_getEntityRecords = (kind, name, query = {}) => async ({
  ...
  try {
    ...
    const path = (0,external_jk_url_namespaceObject.addQueryArgs)(entityConfig.baseURL, {
      ...entityConfig.baseURLParams,
      ...query
    });
    let records, meta;
    if (entityConfig.supportsPagination && query.per_page !== -1) {
      ...
      meta = {
        totalItems: parseInt(response.headers.get('X-JK-Total')),
        totalPages: parseInt(response.headers.get('X-JK-TotalPages'))
      };
    } else {
      records = Object.values(await external_jk_apiFetch_default()({
        path
      }));
      meta = {
    ...
    registry.batch(() => {
      ...
      // See https://github.com/JKPress/gutenberg/pull/26575
      // See https://github.com/JKPress/gutenberg/pull/64504
...
const resolvers_getEmbedPreview = url => async ({
  ...
  try {
    const embedProxyResponse = await external_jk_apiFetch_default()({
      path: (0,external_jk_url_namespaceObject.addQueryArgs)('/oembed/1.0/proxy', {
        url
      })
    });
...
const resolvers_canUser = (requestedAction, resource, id) => async ({
  ...
  if (typeof resource === 'object') {
    ...
    resourcePath = `/jk/v2/${resource}` + (id ? '/' + id : '');
  }
  const {
  ...
  let response;
  try {
    response = await external_jk_apiFetch_default()({
      path: resourcePath,
      method: 'OPTIONS',
      parse: false
    });
...
const resolvers_getAutosaves = (postType, postId) => async ({
  ...
  const {
    rest_base: restBase,
    rest_namespace: restNamespace = 'jk/v2'
  } = await resolveSelect.getPostType(postType);
  const autosaves = await external_jk_apiFetch_default()({
...
const resolvers_experimentalGetTemplateForLink = link => async ({
  ...
  try {
    ...
    // an Ajax function which has a different shape from a JK_REST_Response.
    template = await external_jk_apiFetch_default()({
      url: (0,external_jk_url_namespaceObject.addQueryArgs)(link, {
        '_jk-find-template': true
      })
    }).then(({
      data
    }) => data);
  ...
  const record = await resolveSelect.getEntityRecord('postType', 'jk_template', template.id);
  if (record) {
    dispatch.receiveEntityRecords('postType', 'jk_template', [record], {
      'find-template': link
    });
  }
};
resolvers_experimentalGetTemplateForLink.shouldInvalidate = action => {
  return (action.type === 'RECEIVE_ITEMS' || action.type === 'REMOVE_ITEMS') && action.invalidateCache && action.kind === 'postType' && action.name === 'jk_template';
};
const resolvers_experimentalGetCurrentGlobalStylesId = () => async ({
  ...
  const globalStylesURL = activeThemes?.[0]?._links?.['jk:user-global-styles']?.[0]?.href;
  if (!globalStylesURL) {
    return;
  }
...
const resolvers_experimentalGetCurrentThemeBaseGlobalStyles = () => async ({
  ...
  const themeGlobalStyles = await external_jk_apiFetch_default()({
    path: `/jk/v2/global-styles/themes/${currentTheme.stylesheet}?context=view`
  });
...
const resolvers_experimentalGetCurrentThemeGlobalStylesVariations = () => async ({
  ...
  const currentTheme = await resolveSelect.getCurrentTheme();
  // Please adjust the preloaded requests if this changes!
  const variations = await external_jk_apiFetch_default()({
    path: `/jk/v2/global-styles/themes/${currentTheme.stylesheet}/variations?context=view`
  });
...
const resolvers_getCurrentThemeGlobalStylesRevisions = () => async ({
  ...
  if (revisionsURL) {
    const resetRevisions = await external_jk_apiFetch_default()({
      url: revisionsURL
    });
...
const resolvers_getBlockPatternCategories = () => async ({
  ...
  const categories = await external_jk_apiFetch_default()({
    path: '/jk/v2/block-patterns/categories'
  });
  dispatch({
...
const resolvers_getUserPatternCategories = () => async ({
  ...
  const patternCategories = await resolveSelect.getEntityRecords('taxonomy', 'jk_pattern_category', {
    per_page: -1,
  ...
  const mappedPatternCategories = patternCategories?.map(userCategory => ({
    ...userCategory,
    label: (0,external_jk_htmlEntities_namespaceObject.decodeEntities)(userCategory.name),
...
const resolvers_getNavigationFallbackId = () => async ({
  ...
  const fallback = await external_jk_apiFetch_default()({
    path: (0,external_jk_url_namespaceObject.addQueryArgs)('/jk-block-editor/v1/navigation-fallback', {
      _embed: true
    })
  });
  ...
  registry.batch(() => {
    ...
    const existingFallbackEntityRecord = select.getEntityRecord('postType', 'jk_navigation', fallback.id);
    const invalidateNavigationQueries = !existingFallbackEntityRecord;
    dispatch.receiveEntityRecords('postType', 'jk_navigation', record, undefined, invalidateNavigationQueries);

    // Resolve to avoid further network requests.
    dispatch.finishResolution('getEntityRecord', ['postType', 'jk_navigation', fallback.id]);
  });
};
const resolvers_getDefaultTemplateId = query => async ({
  dispatch
}) => {
  const template = await external_jk_apiFetch_default()({
    path: (0,external_jk_url_namespaceObject.addQueryArgs)('/jk/v2/templates/lookup', query)
  });
...
const resolvers_getRevisions = (kind, name, recordKey, query = {}) => async ({
  ...
  const path = (0,external_jk_url_namespaceObject.addQueryArgs)(entityConfig.getRevisionsUrl(recordKey), query);
  ...
  if (response) {
    if (isPaginated) {
      records = Object.values(await response.json());
      meta.totalItems = parseInt(response.headers.get('X-JK-Total'));
    } else {
...
const resolvers_getRevision = (kind, name, recordKey, revisionKey, query) => async ({
  ...
  const path = (0,external_jk_url_namespaceObject.addQueryArgs)(entityConfig.getRevisionsUrl(recordKey, revisionKey), query);
  let record;
  try {
    record = await external_jk_apiFetch_default()({
      path
    });
  } catch (error) {
    // Do nothing if our request comes back with an API error.
...
const resolvers_getRegisteredPostMeta = postType => async ({
  ...
  try {
    ...
    options = await external_jk_apiFetch_default()({
...
const {
  lock,
  unlock
} = (0,external_jk_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of JKPress.', '@wordpress/core-data');
...
const EntityContext = (0,external_jk_element_namespaceObject.createContext)({});
...
function EntityProvider({
  ...
  const parent = (0,external_jk_element_namespaceObject.useContext)(EntityContext);
  const childContext = (0,external_jk_element_namespaceObject.useMemo)(() => ({
    ...parent,
    [kind]: {
      ...parent?.[kind],
      [name]: id
 ...
 *
 * @since 6.1.0 Introduced in JKPress core.
 * @private
 *
...
function useQuerySelect(mapQuerySelect, deps) {
  return (0,external_jk_data_namespaceObject.useSelect)((select, registry) => {
...
function useEntityRecord(kind, name, recordId, options = {
  ...
  const mutations = (0,external_jk_element_namespaceObject.useMemo)(() => ({
...
function __experimentalUseEntityRecord(kind, name, recordId, options) {
  external_jk_deprecated_default()(`jk.data.__experimentalUseEntityRecord`, {
    alternative: 'jk.data.useEntityRecord',
    since: '6.1'
  });
...
function useEntityRecords(kind, name, queryArgs = {}, options = {
  ...
  const queryAsString = (0,external_jk_url_namespaceObject.addQueryArgs)('', queryArgs);
  const {
    data: records,
    ...rest
  } = useQuerySelect(query => {
...
function __experimentalUseEntityRecords(kind, name, queryArgs, options) {
  external_jk_deprecated_default()(`jk.data.__experimentalUseEntityRecords`, {
    alternative: 'jk.data.useEntityRecords',
    since: '6.1'
  });
...
function useEntityRecordsWithPermissions(kind, name, queryArgs = {}, options = {
  ...
  const entityConfig = (0,external_jk_data_namespaceObject.useSelect)(select => select(store).getEntityConfig(kind, name), [kind, name]);
  const {
    records: data,
    ...ret
  } = useEntityRecords(kind, name, queryArgs, options);
  const ids = (0,external_jk_element_namespaceObject.useMemo)(() => {
    var _data$map;
  ...
  const permissions = (0,external_jk_data_namespaceObject.useSelect)(select => {
    const {
      getEntityRecordsPermissions
    } = unlock(select(store));
    return getEntityRecordsPermissions(kind, name, ids);
  }, [ids, kind, name]);
  const dataWithPermissions = (0,external_jk_element_namespaceObject.useMemo)(() => {
    var _data$map2;
...
function useResourcePermissions(resource, id) {
  ...
  if (isEntity && typeof id !== 'undefined') {
     true ? external_jk_warning_default()(`When 'resource' is an entity object, passing 'id' as a separate argument isn't supported.`) : 0;
  }
...
function __experimentalUseResourcePermissions(resource, id) {
  external_jk_deprecated_default()(`jk.data.__experimentalUseResourcePermissions`, {
    alternative: 'jk.data.useResourcePermissions',
    since: '6.1'
  });
...
function useEntityId(kind, name) {
  const context = (0,external_jk_element_namespaceObject.useContext)(EntityContext);
...
//
// Fix once https://github.com/JKPress/gutenberg/issues/52692 is closed.
let unlockedApis;
const cache = new WeakMap();
function getRichTextValuesCached(block) {
  if (!unlockedApis) {
    unlockedApis = unlock(external_jk_blockEditor_namespaceObject.privateApis);
  }
  if (!cache.has(block)) {
...
function updateFootnotesFromMeta(blocks, meta) {
  ...
  function updateAttributes(attributes) {
    ...
    for (const key in attributes) {
      ...
      if (typeof value !== 'string' && !(value instanceof external_jk_richText_namespaceObject.RichTextData)) {
        continue;
      }
      const richTextValue = typeof value === 'string' ? external_jk_richText_namespaceObject.RichTextData.fromHTMLString(value) : new external_jk_richText_namespaceObject.RichTextData(value);
      ...
      richTextValue.replacements.forEach(replacement => {
        if (replacement.type === 'core/footnote') {
          ...
          const countValue = (0,external_jk_richText_namespaceObject.create)({
          ...
          replacement.innerHTML = (0,external_jk_richText_namespaceObject.toHTMLString)({
            value: countValue
          });
          hasFootnotes = true;
        }
...
function useEntityBlockEditor(kind, name, {
  ...
  } = (0,external_jk_data_namespaceObject.useSelect)(STORE_NAME);
  const {
    content,
    editedBlocks,
    meta
  ...
  const {
    ...
    editEntityRecord
  } = (0,external_jk_data_namespaceObject.useDispatch)(STORE_NAME);
  const blocks = (0,external_jk_element_namespaceObject.useMemo)(() => {
    if (!id) {
      return undefined;
    }
    if (editedBlocks) {
    ...
    if (!_blocks) {
      _blocks = (0,external_jk_blocks_namespaceObject.parse)(content);
      parsedBlocksCache.set(cackeKey, _blocks);
    }
    return _blocks;
  }, [kind, name, id, editedBlocks, content, getEntityRecord, getEntityRecordEdits]);
  const updateFootnotes = (0,external_jk_element_namespaceObject.useCallback)(_blocks => updateFootnotesFromMeta(_blocks, meta), [meta]);
  const onChange = (0,external_jk_element_namespaceObject.useCallback)((newBlocks, options) => {
    ...
    const edits = {
      ...
      }) => (0,external_jk_blocks_namespaceObject.__unstableSerializeAndClean)(blocksForSerialization),
  ...
  const onInput = (0,external_jk_element_namespaceObject.useCallback)((newBlocks, options) => {
    const {
      selection,
      ...rest
    } = options;
...
function useEntityProp(kind, name, prop, _id) {
  ...
  const setValue = (0,external_jk_element_namespaceObject.useCallback)(newValue => {
...
(0,external_jk_data_namespaceObject.register)(store); // Register store after unlocking private selectors to allow resolvers to use them.
...
(window.jk = window.jk || {}).coreData = __webpack_exports__;
/******/ })()
;