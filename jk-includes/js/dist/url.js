 ...
 * const imageUrl = filterURLForDisplay( 'https://www.wordpress.org/jk-content/uploads/img.png', 20 ); // …ent/uploads/img.png
 * ```
 *
 ...
 *
 * This replicates some of what `sanitize_title()` does in JKPress core, but
...
(window.jk = window.jk || {}).url = __webpack_exports__;
/******/ })()
;