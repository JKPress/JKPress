...
const widget = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
...
const brush = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.Path, {
...
function WidgetTypeSelector({
  ...
  const widgetTypes = (0,external_jk_data_namespaceObject.useSelect)(select => {
    var _select$getSettings$w;
    const hiddenIds = (_select$getSettings$w = select(external_jk_blockEditor_namespaceObject.store).getSettings()?.widgetTypesToHideFromLegacyWidgetBlock) !== null && _select$getSettings$w !== void 0 ? _select$getSettings$w : [];
    return select(external_jk_coreData_namespaceObject.store).getWidgetTypes({
      per_page: -1
    })?.filter(widgetType => !hiddenIds.includes(widgetType.id));
  }, []);
  if (!widgetTypes) {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Spinner, {});
  }
  if (widgetTypes.length === 0) {
    return (0,external_jk_i18n_namespaceObject.__)('There are no widgets available.');
  }
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.SelectControl, {
    __next40pxDefaultSize: true,
    __nextHasNoMarginBottom: true,
    label: (0,external_jk_i18n_namespaceObject.__)('Legacy widget'),
    value: selectedId !== null && selectedId !== void 0 ? selectedId : '',
    options: [{
      value: '',
      label: (0,external_jk_i18n_namespaceObject.__)('Select widget')
...
function InspectorCard({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    className: "jk-block-legacy-widget-inspector-card",
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
      className: "jk-block-legacy-widget-inspector-card__name",
      children: name
...
class Control {
  ...
  constructor({
    ...
    this.handleFormChange = (0,external_jk_compose_namespaceObject.debounce)(this.handleFormChange.bind(this), 200);
  ...
  initDOM() {
    ...
    this.id && el('button', {
      ...
      type: 'submit'
    }, (0,external_jk_i18n_namespaceObject.__)('Save'))])])]);
  }
...
async function saveWidget(id, formData = null) {
  let widget;
  if (formData) {
    widget = await external_jk_apiFetch_default()({
      path: `/jk/v2/widgets/${id}?context=edit`,
      method: 'PUT',
      data: {
        form_data: formData
      }
...
async function encodeWidget({
  ...
  const response = await external_jk_apiFetch_default()({
    path: `/jk/v2/widget-types/${idBase}/encode`,
    method: 'POST',
    data: {
      instance,
      number,
...
function Form({
  ...
  const isMediumLargeViewport = (0,external_jk_compose_namespaceObject.useViewportMatch)('small');

  // We only want to remount the control when the instance changes
  // *externally*. For example, if the user performs an undo. To do this, we
  // keep track of changes made to instance by the control itself and then
  // ignore those.
  const outgoingInstances = (0,external_jk_element_namespaceObject.useRef)(new Set());
  const incomingInstances = (0,external_jk_element_namespaceObject.useRef)(new Set());
  const {
    createNotice
  ...
  (0,external_jk_element_namespaceObject.useEffect)(() => {
    ...
    const control = new Control({
      ...
      onError(error) {
        ...
        createNotice('error', (0,external_jk_i18n_namespaceObject.sprintf)( /* translators: %s: the name of the affected block. */
        (0,external_jk_i18n_namespaceObject.__)('The "%s" block was affected by errors and may not function properly. Check the developer tools for more details.'), idBase || id));
      }
    });
  ...
  if (isWide && isMediumLargeViewport) {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      className: dist_clsx({
        'jk-block-legacy-widget__container': isVisible
      }),
      children: [isVisible && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
        className: "jk-block-legacy-widget__edit-form-title",
        children: title
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Popover, {
        focusOnMount: false,
        placement: "right",
        offset: 32,
        resize: false,
        ...
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
          ref: ref,
          className: "jk-block-legacy-widget__edit-form",
          hidden: !isVisible
        })
      })]
    });
...
function Preview({
  ...
  const [isLoaded, setIsLoaded] = (0,external_jk_element_namespaceObject.useState)(false);
  const [srcDoc, setSrcDoc] = (0,external_jk_element_namespaceObject.useState)('');
  (0,external_jk_element_namespaceObject.useEffect)(() => {
    const abortController = typeof window.AbortController === 'undefined' ? undefined : new window.AbortController();
    async function fetchPreviewHTML() {
      const restRoute = `/jk/v2/widget-types/${idBase}/render`;
      return await external_jk_apiFetch_default()({
        path: restRoute,
        method: 'POST',
  ...
  const ref = (0,external_jk_compose_namespaceObject.useRefEffect)(iframe => {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [isVisible && !isLoaded && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Placeholder, {
      ...
      className: dist_clsx('jk-block-legacy-widget__edit-preview', {
        'is-offscreen': !isVisible || !isLoaded
      }),
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Disabled, {
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("iframe", {
          ref: ref,
          className: "jk-block-legacy-widget__edit-preview-iframe",
          tabIndex: "-1",
          title: (0,external_jk_i18n_namespaceObject.__)('Legacy Widget Preview'),
          srcDoc: srcDoc,
          onLoad: event => {
...
function NoPreview({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    className: "jk-block-legacy-widget__edit-no-preview",
    children: [name && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
      children: name
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
      children: (0,external_jk_i18n_namespaceObject.__)('No preview available.')
    })]
  });
}
...
function ConvertToBlocksButton({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.ToolbarButton, {
    onClick: () => {
      if (rawInstance.title) {
        replaceBlocks(clientId, [(0,external_jk_blocks_namespaceObject.createBlock)('core/heading', {
          content: rawInstance.title
        }), ...(0,external_jk_blocks_namespaceObject.rawHandler)({
          HTML: rawInstance.text
        })]);
      } else {
        replaceBlocks(clientId, (0,external_jk_blocks_namespaceObject.rawHandler)({
          HTML: rawInstance.text
        }));
      }
    },
    children: (0,external_jk_i18n_namespaceObject.__)('Convert to blocks')
  });
}
...
function Edit(props) {
  ...
  const blockProps = (0,external_jk_blockEditor_namespaceObject.useBlockProps)({
    className: dist_clsx({
...
function Empty({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Placeholder, {
    icon: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.BlockIcon, {
      icon: library_brush
    }),
    label: (0,external_jk_i18n_namespaceObject.__)('Legacy Widget'),
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Flex, {
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.FlexBlock, {
...
function NotEmpty({
  ...
  const [hasPreview, setHasPreview] = (0,external_jk_element_namespaceObject.useState)(null);
  const widgetTypeId = id !== null && id !== void 0 ? id : idBase;
  const {
    record: widgetType,
    hasResolved: hasResolvedWidgetType
  } = (0,external_jk_coreData_namespaceObject.useEntityRecord)('root', 'widgetType', widgetTypeId);
  const isNavigationMode = (0,external_jk_data_namespaceObject.useSelect)(select => select(external_jk_blockEditor_namespaceObject.store).isNavigationMode(), []);
  const setInstance = (0,external_jk_element_namespaceObject.useCallback)(nextInstance => {
    setAttributes({
  ...
  if (!widgetType && hasResolvedWidgetType) {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Placeholder, {
      ...
      label: (0,external_jk_i18n_namespaceObject.__)('Legacy Widget'),
      children: (0,external_jk_i18n_namespaceObject.__)('Widget is missing.')
    });
  }
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [idBase === 'text' && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.BlockControls, {
      group: "other",
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(ConvertToBlocksButton, {
        clientId: clientId,
        rawInstance: instance.raw
      })
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.InspectorControls, {
      ...
      children: [hasPreview === null && mode === 'preview' && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Placeholder, {
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Spinner, {})
...
const legacyWidgetTransforms = [{
  ...
  return {
    ...
    transform: ({
      ...
      const transformedBlock = (0,external_jk_blocks_namespaceObject.createBlock)(block, transform ? transform(instance.raw) : undefined);
      if (!instance.raw?.title) {
        return transformedBlock;
      }
      return [(0,external_jk_blocks_namespaceObject.createBlock)('core/heading', {
...
const metadata = {
  ...
  editorStyle: "jk-block-legacy-widget-editor"
};
...
const group = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
  viewBox: "0 0 24 24",
  xmlns: "http://www.w3.org/2000/svg",
  children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.Path, {
...
function edit_Edit(props) {
  ...
  const {
    innerBlocks
  } = (0,external_jk_data_namespaceObject.useSelect)(select => select(external_jk_blockEditor_namespaceObject.store).getBlock(clientId), [clientId]);
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
...
function PlaceholderContent({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.Placeholder, {
      className: "jk-block-widget-group__placeholder",
      icon: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.BlockIcon, {
        icon: library_group
      }),
      label: (0,external_jk_i18n_namespaceObject.__)('Widget Group'),
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.ButtonBlockAppender, {
        rootClientId: clientId
      })
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.InnerBlocks, {
...
function PreviewContent({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.RichText, {
      tagName: "h2",
      identifier: "title",
      className: "widget-title",
      allowedFormats: [],
      placeholder: (0,external_jk_i18n_namespaceObject.__)('Title'),
...
function save({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.RichText.Content, {
      tagName: "h2",
      className: "widget-title",
      value: attributes.title
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      className: "jk-widget-group__inner-blocks",
      children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.InnerBlocks.Content, {})
    })]
  });
}
  ...
  save({
    ...
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.RichText.Content, {
        ...
        className: "widget-title",
        value: attributes.title
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_blockEditor_namespaceObject.InnerBlocks.Content, {})]
    });
  }
};
...
const widget_group_metadata = {
  ...
  editorStyle: "jk-block-widget-group-editor",
  style: "jk-block-widget-group"
};
...
const widget_group_settings = {
  title: (0,external_jk_i18n_namespaceObject.__)('Widget Group'),
  description: (0,external_jk_i18n_namespaceObject.__)('Create a classic widget layout with a title that’s styled by your theme for your widget areas.'),
  icon: library_group,
  __experimentalLabel: ({
    name: label
  }) => label,
    ...
    from: [{
      ...
      __experimentalConvert(blocks) {
        ...
        let innerBlocks = [...blocks.map(block => {
          return (0,external_jk_blocks_namespaceObject.createBlock)(block.name, block.attributes, block.innerBlocks);
        })];
        ...
        return (0,external_jk_blocks_namespaceObject.createBlock)('core/widget-group', {
          ...(firstHeadingBlock && {
...
const moveTo = /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_primitives_namespaceObject.Path, {
...
function MoveToWidgetArea({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.ToolbarGroup, {
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.ToolbarItem, {
      children: toggleProps => /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.DropdownMenu, {
        icon: move_to,
        label: (0,external_jk_i18n_namespaceObject.__)('Move to widget area'),
        toggleProps: toggleProps,
        children: ({
          onClose
        }) => /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.MenuGroup, {
          label: (0,external_jk_i18n_namespaceObject.__)('Move to'),
          children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_jk_components_namespaceObject.MenuItemsChoice, {
...
function registerLegacyWidgetVariations(settings) {
  const unsubscribe = (0,external_jk_data_namespaceObject.subscribe)(() => {
    ...
    const widgetTypes = (0,external_jk_data_namespaceObject.select)(external_jk_coreData_namespaceObject.store).getWidgetTypes({
      per_page: -1
    })?.filter(widgetType => !hiddenIds.includes(widgetType.id));
    if (widgetTypes) {
      unsubscribe();
      (0,external_jk_data_namespaceObject.dispatch)(external_jk_blocks_namespaceObject.store).addBlockVariations('core/legacy-widget', widgetTypes.map(widgetType => ({
        name: widgetType.id,
        title: widgetType.name,
        description: widgetType.description,
...
function registerLegacyWidgetBlock(supports = {}) {
  ...
  (0,external_jk_blocks_namespaceObject.registerBlockType)({
    name,
    ...metadata
  }, {
    ...settings,
...
(window.jk = window.jk || {}).widgets = __webpack_exports__;
/******/ })()
;