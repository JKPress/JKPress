...
/** @typedef {import('./index').JKWordCountStrategy} JKWordCountStrategy */

/** @typedef {Partial<{type: JKWordCountStrategy, shortcodes: string[]}>} JKWordCountL10n */

/**
 * @typedef JKWordCountSettingsFields
 ...
 * @property {RegExp}              shortcodesRegExp                  Regular expression that matches JKPress shortcodes
 * @property {string[]}            shortcodes                        List of all shortcodes
 * @property {JKWordCountStrategy} type                              Describes what and how are we counting
 * @property {JKWordCountL10n}     l10n                              Object with human translations
 */

/**
 * Lower-level settings for word counting that can be overridden.
 *
 * @typedef {Partial<JKWordCountSettingsFields>} JKWordCountUserSettings
 */
 ...
 *
 * @typedef {JKWordCountUserSettings & typeof defaultSettings} JKWordCountDefaultSettings
 */
 ...
 *
 * @param {import('./index').JKWordCountSettings} settings The main settings object containing regular expressions
...
/**
 * @typedef {import('./defaultSettings').JKWordCountDefaultSettings}  JKWordCountSettings
 * @typedef {import('./defaultSettings').JKWordCountUserSettings}     JKWordCountUserSettings
 */

/**
 * Possible ways of counting.
 *
 * @typedef {'words'|'characters_excluding_spaces'|'characters_including_spaces'} JKWordCountStrategy
 */

/**
 * Private function to manage the settings.
 *
 * @param {JKWordCountStrategy}     type         The type of count to be done.
 * @param {JKWordCountUserSettings} userSettings Custom settings for the count.
 *
 * @return {JKWordCountSettings} The combined settings object to be used.
 */
 ...
 * @param {JKWordCountSettings} settings Settings object containing regular expressions for each strip function
 *
 ...
 *
 * @param {string}                  text         The text being processed
 * @param {JKWordCountStrategy}     type         The type of count. Accepts 'words', 'characters_excluding_spaces', or 'characters_including_spaces'.
 * @param {JKWordCountUserSettings} userSettings Custom settings object.
 *
 * @example
 * ```js
...
(window.jk = window.jk || {}).wordcount = __webpack_exports__;
/******/ })()
;