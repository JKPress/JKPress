...
/**
 * @typedef {Object} JKNoticeAction Object describing a user action option associated with a notice.
 *
 ...
 *                                                             announced to screen
 *                                                             readers.
 * @param {Array<JKNoticeAction>} [options.actions]            User actions to be
...
/** @typedef {import('./actions').JKNoticeAction} JKNoticeAction */
...
/**
 * @typedef {Object} JKNotice Notice object.
 *
 ...
 *                                             `true`.
 * @property {JKNoticeAction[]} actions        User actions to present with notice.
 */
 ...
 *```
 *
 * @return {JKNotice[]} Array of notices.
 */
 ...
 */
const store = (0,external_jk_data_namespaceObject.createReduxStore)('core/notices', {
  reducer: reducer,
...
(window.jk = window.jk || {}).notices = __webpack_exports__;
/******/ })()
;