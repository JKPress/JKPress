...
function applyAnnotations(record, annotations = []) {
  annotations.forEach(annotation => {
    ...
    record = (0,external_jk_richText_namespaceObject.applyFormat)(record, {
      type: FORMAT_NAME,
      attributes: {
        className,
        id
...
const annotation = {
  name: FORMAT_NAME,
  title: (0,external_jk_i18n_namespaceObject.__)('Annotation'),
  tagName: 'mark',
...
(0,external_jk_richText_namespaceObject.registerFormatType)(format_name, settings);
...
const addAnnotationClassName = OriginalComponent => {
  return (0,external_jk_data_namespaceObject.withSelect)((select, {
    clientId,
    className
  }) => {
...
(0,external_jk_hooks_namespaceObject.addFilter)('editor.BlockListBlock', 'core/annotations', addAnnotationClassName);
 ...
 */
const __experimentalGetAnnotationsForBlock = (0,external_jk_data_namespaceObject.createSelector)((state, blockClientId) => {
  var _state$blockClientId;
 ...
 */
const __experimentalGetAnnotationsForRichText = (0,external_jk_data_namespaceObject.createSelector)((state, blockClientId, richTextIdentifier) => {
 ...
 * @param {JKAnnotationRange} annotation.range              The range at which to apply this annotation.
...
(window.jk = window.jk || {}).annotations = __webpack_exports__;
/******/ })()
;