/**
 * @output jk-includes/js/jk-backbone.js
 */
...
(function ($) {
	/**
	 * Create the JKPress Backbone namespace.
	 *
	 * @namespace jk.Backbone
	 */
	jk.Backbone = {};
	 ...
	 *
	 * @since 3.5.0
	 * @since 3.6.0 Moved jk.media.Views to jk.Backbone.Subviews.
	 *
	 * @memberOf jk.Backbone
	 *
	 * @class
	 *
	 * @param {jk.Backbone.View} view  The main view.
	 * @param {Array|Object}     views The subviews for the main view.
	 */
	jk.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	jk.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( jk.Backbone.Subviews.prototype, {
		/**
		 ...
		 *
		 * @return {jk.Backbone.Subviews} The current Subviews instance.
		 */
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || jk.Backbone.Subviews,
	...
	jk.Backbone.View = Backbone.View.extend({

		// The constructor for the `Views` manager.
		Subviews: jk.Backbone.Subviews,
		 ...
		 *
		 * @since 3.5.0
		 * @since 3.6.0 Moved jk.media.View to jk.Backbone.View
		 *
		 * @constructs
		 ...
		 * @since 3.5.0
		 *
		 * @return {jk.Backbone.View} The current instance of the view.
		 */
		render: function() {
			var options;
