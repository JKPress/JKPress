/**
 * @output jk-includes/js/customize-loader.js
 */

/* global _jkCustomizeLoaderSettings */
...
(function( exports, $ ){
	 ...
	 *
	 *     e.g. <a class="load-customize" href="<?php echo jk_customize_url(); ?>">Open Customizer</a>
	 *
	 * @memberOf jk.customize
	 *
	 * @class
	 * @augments jk.customize.Events
	 */
	Loader = $.extend( {}, api.Events,/** @lends jk.customize.Loader.prototype */{
		/**
		...
		hashchange: function() {
			...
			if ( hash && 0 === hash.indexOf( 'jk_customize=on' ) ) {
		...
		pushState: function ( src ) {
			...
			if ( $.support.history && window.location.href !== src ) {
				...
				window.location.hash = 'jk_customize=on&' + hash;
			}
	...
	$( function() {
		Loader.settings = _jkCustomizeLoaderSettings;
		Loader.initialize();
	});

	// Expose the API publicly on window.jk.customize.Loader.
	api.Loader = Loader;
})( jk, jQuery );
