...
( function() {
	...
	tinyMCE.addI18n( lang + ".wordpress", {
		jk_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		jk_more_desc: "Insert More Tag (Alt + Shift + T)",
		jk_page_desc: "Insert Page break (Alt + Shift + P)",
		jk_help_desc: "Help (Alt + Shift + H)",
		jk_more_alt: "More...",
		jk_page_alt: "Next page...",
		add_media: "Add Media",
		...
		jk_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});
