/**
 * @output jk-includes/js/customize-preview-widgets.js
 */

/* global _jkWidgetCustomizerPreviewSettings */
 ...
 * @since 4.5.0
 *
 * @namespace jk.customize.widgetsPreview
 *
 * @param {jQuery} $   The jQuery object.
 * @param {Object} _   The utilities library.
 * @param {Object} jk  Current JKPress environment instance.
 * @param {Object} api Information from the API.
 *
 * @return {Object} Widget-related variables.
 */
jk.customize.widgetsPreview = jk.customize.WidgetCustomizerPreview = (function( $, _, jk, api ) {
	 ...
	 * @since 4.5.0
	 *
	 * @memberOf jk.customize.widgetsPreview
	 *
	 * @return {void}
	 */
	self.init = function() {
	...
	self.WidgetPartial = api.selectiveRefresh.Partial.extend(/** @lends jk.customize.widgetsPreview.WidgetPartial.prototype */{
		 ...
		 *
		 * @alias jk.customize.widgetsPreview.WidgetPartial
		 * @memberOf jk.customize.widgetsPreview
		 *
		 ...
		 *
		 * @inheritDoc
		 * @param {jk.customize.selectiveRefresh.Placement} placement The placement
		 *                                                            function.
		 *
		 * @return {void}
		 */
	...
	self.SidebarPartial = api.selectiveRefresh.Partial.extend(/** @lends jk.customize.widgetsPreview.SidebarPartial.prototype */{
		 ...
		 *
		 * @memberOf jk.customize.widgetsPreview
		 * @alias jk.customize.widgetsPreview.SidebarPartial
		 *
		 * @param {string} id             The partial's ID.
		 ...
		 * @since 4.5.0
		 *
		 * @return {Array.<jk.customize.selectiveRefresh.Placement>} List of placements
		 *                                                           that were reflowed.
		 */
		 ...
		 *
		 * @return {jk.customize.selectiveRefresh.Partial} The widget instance partial.
		 */
	...
	api.bind( 'preview-ready', function() {
		$.extend( self, _jkWidgetCustomizerPreviewSettings );
		self.init();
	});
