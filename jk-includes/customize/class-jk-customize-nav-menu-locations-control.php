<?php
/**
 * Customize API: JK_Customize_Nav_Menu_Locations_Control class
 *
 * @package JKPress
 ...
 */
class JK_Customize_Nav_Menu_Locations_Control extends JK_Customize_Control {
		...
		if ( current_theme_supports( 'menus' ) ) :
			...
			<ul class="menu-location-settings">
				<li class="customize-control assigned-menu-locations-title">
					<span class="customize-control-title">{{ jk.customize.Menus.data.l10n.locationsTitle }}</span>
					<# if ( data.isCreating ) { #>
						<p>
