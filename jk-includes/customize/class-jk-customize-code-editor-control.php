<?php
/**
 * Customize API: JK_Customize_Code_Editor_Control class
 *
 * @package JKPress
 ...
 */
class JK_Customize_Code_Editor_Control extends JK_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = jk_enqueue_code_editor(
			array_merge(
				array(
					'type'       => $this->code_type,
					'codemirror' => array(
