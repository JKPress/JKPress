<?php
/**
 * Customize API: JK_Widget_Form_Customize_Control class
 *
 * @package JKPress
 ...
 */
class JK_Widget_Form_Customize_Control extends JK_Customize_Control {
	/**
	...
	public function to_json() {
		...
		$widget = $jk_registered_widgets[ $this->widget_id ];
		...
		$args                 = jk_list_widget_controls_dynamic_sidebar(
			array(
				0 => $args,
				1 => $widget['params'][0],
			)
