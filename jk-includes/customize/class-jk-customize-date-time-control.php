<?php
/**
 * Customize API: JK_Customize_Date_Time_Control class
 *
 * @package JKPress
 ...
 */
class JK_Customize_Date_Time_Control extends JK_Customize_Control {
	...
	public function content_template() {
		...
		<# _.defaults( data, <?php echo jk_json_encode( $data ); ?> ); #>
	...
	public function get_month_choices() {
		...
		$months = array();
		for ( $i = 1; $i < 13; $i++ ) {
			$month_text = $jk_locale->get_month_abbrev( $jk_locale->get_month( $i ) );
