 ...
 * JKPress PHPMailer class.
 *
 * Overrides the internationalization method in order to use JKPress' instead.
 *
 * @since 6.8.0
 */
class JK_PHPMailer extends PHPMailer\PHPMailer\PHPMailer {
	...
	/**
	 * Defines the error messages using JKPress' internationalization method.
	 *
	 * @since 6.8.0
	 *
