<?php
/**
 * Feed API: JK_SimplePie_Sanitize_KSES class
 *
 * @package JKPress
 * @subpackage Feed
 * @since 4.7.0
...
class JK_SimplePie_Sanitize_KSES extends SimplePie\Sanitize {

	/**
	 * JKPress SimplePie sanitization using KSES.
	 *
