<?php
/**
 * Diff API: JK_Text_Diff_Renderer_Table class
 *
 * @package JKPress
 * @subpackage Diff
 * @since 4.7.0
...
class JK_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'JK_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ( $lines as $line ) {
			if ( $encode ) {
				...
				/** This filter is documented in jk-includes/jk-diff.php */
