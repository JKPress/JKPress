...
final class JK_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $hook_name, $callback, $priority, $accepted_args ) {
		$idx = _jk_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function remove_filter( $hook_name, $callback, $priority ) {
		$function_key = _jk_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function has_filter( $hook_name = '', $callback = false ) {
		...
		$function_key = _jk_filter_build_unique_id( $hook_name, $callback, false );
	...
	/**
	 * Normalizes filters set up before JKPress has initialized to JK_Hook objects.
	 *
	 ...
	 * @return JK_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var JK_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $hook_name => $callback_groups ) {
			if ( $callback_groups instanceof JK_Hook ) {
