<?php
/**
 * Dependencies API: JK_Styles class
 *
 * @since 2.6.0
 *
 * @package JKPress
 ...
 * @see JK_Dependencies
 */
class JK_Styles extends JK_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		...
		/**
		 * Fires when the JK_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param JK_Styles $jk_styles JK_Styles instance (passed by reference).
		 */
		do_action_ref_array( 'jk_default_styles', array( &$this ) );
	}
	...
	public function do_item( $handle, $group = false ) {
		...
		if ( 'rtl' === $this->text_direction && isset( $obj->extra['rtl'] ) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in jk-includes/class-jk-styles.php */
