 ...
 * Block Bindings API
 *
 * Contains functions for managing block bindings in JKPress.
 *
 * @package JKPress
 ...
 *                                                                              i.e. {"key": "foo"}.
 *                                            - @param JK_Block $block_instance The block instance.
 ...
 * }
 * @return JK_Block_Bindings_Source|false Source when the registration was successful, or `false` on failure.
 */
function register_block_bindings_source( string $source_name, array $source_properties ) {
	return JK_Block_Bindings_Registry::get_instance()->register( $source_name, $source_properties );
}
 ...
 * @return JK_Block_Bindings_Source|false The unregistered block bindings source on success and `false` otherwise.
 */
function unregister_block_bindings_source( string $source_name ) {
	return JK_Block_Bindings_Registry::get_instance()->unregister( $source_name );
}
 ...
 * @since 6.5.0
 *
 * @return JK_Block_Bindings_Source[] The array of registered block bindings sources.
 */
function get_all_registered_block_bindings_sources() {
	return JK_Block_Bindings_Registry::get_instance()->get_all_registered();
}
 ...
 * @return JK_Block_Bindings_Source|null The registered block bindings source, or `null` if it is not registered.
 */
function get_block_bindings_source( string $source_name ) {
	return JK_Block_Bindings_Registry::get_instance()->get_registered( $source_name );
}
