<?php
/**
 * Appending the jk-block-heading to before rendering the stored `core/heading` block contents.
 *
 * @package JKPress
 */

/**
 * Adds a jk-block-heading class to the heading block content.
 *
 * For example, the following block content:
 *  <h2 class="align-left">Hello World</h2>
 *
 * Would be transformed to:
 *  <h2 class="align-left jk-block-heading">Hello World</h2>
 *
 * @since 6.2.0
 *
