...
function render_block_core_calendar( $attributes ) {
	...
	$calendar = str_replace( 'class="jk-calendar-table', 'class="jk-calendar-table' . $classnames, $calendar );
...
function block_core_calendar_has_published_posts() {
	...
	$has_published_posts = get_option( 'jk_calendar_block_has_published_posts', null );
...
function block_core_calendar_update_has_published_posts() {
	global $jkdb;
	$has_published_posts = (bool) $jkdb->get_var( "SELECT 1 as test FROM {$jkdb->posts} WHERE post_type = 'post' AND post_status = 'publish' LIMIT 1" );
	update_option( 'jk_calendar_block_has_published_posts', $has_published_posts );
