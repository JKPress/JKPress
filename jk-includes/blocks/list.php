<?php
/**
 * Adds the jk-block-list class to the rendered list block.
 *
 * @package JKPress
 */
 ...
 * For example, <ol> is transformed to <ol class="jk-block-list">.
 *
 * @since 6.6.0
 *
 * @see https://github.com/JKPress/gutenberg/issues/12420
 *
...
function block_core_list_render( $attributes, $content ) {
	...
	while ( $processor->next_tag() ) {
		if ( in_array( $processor->get_tag(), $list_tags, true ) ) {
			$processor->add_class( 'jk-block-list' );
			break;
		}
	}
