...
function post_comments_form_block_form_defaults( $fields ) {
	if ( jk_is_block_theme() ) {
		$fields['submit_button'] = '<input name="%1$s" type="submit" id="%2$s" class="jk-block-button__link ' . jk_theme_get_element_class_name( 'button' ) . '" value="%4$s" />';
		$fields['submit_field']  = '<p class="form-submit jk-block-button">%1$s %2$s</p>';
	}
