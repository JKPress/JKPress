 ...
 */
function jk_add_footnotes_to_revision( $fields ) {
	$fields['footnotes'] = __( 'Footnotes' );
	return $fields;
}
add_filter( '_jk_post_revision_fields', 'jk_add_footnotes_to_revision' );
 ...
 */
function jk_get_footnotes_from_revision( $revision_field, $field, $revision ) {
	return get_metadata( 'post', $revision->ID, $field, true );
}
add_filter( '_jk_post_revision_field_footnotes', 'jk_get_footnotes_from_revision', 10, 3 );
