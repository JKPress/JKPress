<?php
/**
 * I18N: JK_Translation_File_MO class.
 *
 * @package JKPress
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class JK_Translation_File_MO.
 *
 * @since 6.5.0
 */
class JK_Translation_File_MO extends JK_Translation_File {
	/**
	 * Endian value.
	 *
	...
	protected function parse_file(): bool {
		...
		$file_contents = file_get_contents( $this->file ); // phpcs:ignore JKPress.JK.AlternativeFunctions.file_get_contents_file_get_contents
