 ...
 * already a JK_Http_Cookie() object, then they are turned into one.
 *
 * @todo The JKPress convention is to use underscores instead of camelCase for function and method
 * names. Need to switch to use underscores instead for the methods.
 *
 * @since 2.8.0
 */
#[AllowDynamicProperties]
class JK_Http_Cookie {
	 ...
	 */
	public function getHeaderValue() { // phpcs:ignore JKPress.NamingConventions.ValidFunctionName.MethodNameInvalid
		 ...
		 */
		return $this->name . '=' . apply_filters( 'jk_http_cookie_value', $this->value, $this->name );
	}

	/**
	 * Retrieve cookie header for usage in the rest of the JKPress HTTP API.
	 *
	 * @since 2.8.0
	 *
	 * @return string
	 */
	public function getFullHeader() { // phpcs:ignore JKPress.NamingConventions.ValidFunctionName.MethodNameInvalid
