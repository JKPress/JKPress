<?php
/**
 * Blocks API: JK_Block_Editor_Context class
 *
 * @package JKPress
 * @since 5.8.0
 */
...
final class JK_Block_Editor_Context {
	/**
	 * String that identifies the block editor being rendered. Can be one of:
	 *
	 * - `'core/edit-post'`         - The post editor at `/jk-admin/edit.php`.
	 * - `'core/edit-widgets'`      - The widgets editor at `/jk-admin/widgets.php`.
	 * - `'core/customize-widgets'` - The widgets editor at `/jk-admin/customize.php`.
	 * - `'core/edit-site'`         - The site editor at `/jk-admin/site-editor.php`.
	 *
