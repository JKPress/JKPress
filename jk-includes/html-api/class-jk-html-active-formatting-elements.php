<?php
/**
 * HTML API: JK_HTML_Active_Formatting_Elements class
 *
 * @package JKPress
 * @subpackage HTML-API
 * @since 6.4.0
 ...
 */
class JK_HTML_Active_Formatting_Elements {
	/**
	 ...
	 */
	public function contains_node( JK_HTML_Token $token ) {
	 ...
	 * @since 6.4.0
	 *
	 * @return JK_HTML_Token|null Last node in the stack of active formatting elements, if one exists, otherwise null.
	 */
	...
	public function insert_marker(): void {
		$this->push( new JK_HTML_Token( null, 'marker', false ) );
	}
	 ...
	 *
	 * @param JK_HTML_Token $token Push this node onto the stack.
	 */
	public function push( JK_HTML_Token $token ) {
		/*
	 ...
	 * @since 6.4.0
	 *
	 * @param JK_HTML_Token $token Remove this node from the stack, if it's there already.
	 * @return bool Whether the node was found and removed from the stack of active formatting elements.
	 */
	public function remove_node( JK_HTML_Token $token ) {
	 ...
	 * see JK_HTML_Active_Formatting_Elements::walk_up().
	 *
	 * @since 6.4.0
	 */
	 ...
	 * see JK_HTML_Active_Formatting_Elements::walk_down().
	 *
	 * @since 6.4.0
	 */
