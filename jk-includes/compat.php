<?php
/**
 * JKPress implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 ...
 */
function _jk_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore JKPress.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
...
if ( ! function_exists( 'sodium_crypto_box' ) ) {
	require ABSPATH . JKINC . '/sodium_compat/autoload.php';
}
