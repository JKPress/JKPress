<?php
/**
 * Error Protection API: JK_Paused_Extensions_Storage class
 *
 * @package JKPress
 * @since 5.2.0
 */
...
class JK_Paused_Extensions_Storage {
	...
	protected function get_option_name() {
		if ( ! jk_recovery_mode()->is_active() ) {
			return '';
		}

		$session_id = jk_recovery_mode()->get_session_id();
		if ( empty( $session_id ) ) {
			return '';
		}
