 ...
 */
function jk_register_alignment_support( $block_type ) {
 ...
 */
function jk_apply_alignment_support( $block_type, $block_attributes ) {
	$attributes        = array();
	$has_align_support = block_has_support( $block_type, 'align', false );
	if ( $has_align_support ) {
...
JK_Block_Supports::get_instance()->register(
	'align',
	array(
		'register_attribute' => 'jk_register_alignment_support',
		'apply'              => 'jk_apply_alignment_support',
	)
);
