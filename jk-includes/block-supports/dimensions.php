 ...
 */
function jk_register_dimensions_support( $block_type ) {
 ...
 */
function jk_apply_dimensions_support( $block_type, $block_attributes ) {
	if ( jk_should_skip_block_supports_serialization( $block_type, 'dimensions' ) ) {
		return array();
	}
	...
	$skip_min_height                      = jk_should_skip_block_supports_serialization( $block_type, 'dimensions', 'minHeight' );
	...
	$styles = jk_style_engine_get_styles( array( 'dimensions' => $dimensions_block_styles ) );
 ...
 */
function jk_render_dimensions_support( $block_content, $block ) {
	...
	if (
		...
		jk_should_skip_block_supports_serialization( $block_type, 'dimensions', 'aspectRatio' )
	) {
...
add_filter( 'render_block', 'jk_render_dimensions_support', 10, 2 );

// Register the block support.
JK_Block_Supports::get_instance()->register(
	'dimensions',
	array(
		'register_attribute' => 'jk_register_dimensions_support',
		'apply'              => 'jk_apply_dimensions_support',
	)
);
