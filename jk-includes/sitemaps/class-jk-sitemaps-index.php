<?php
/**
 * Sitemaps: JK_Sitemaps_Index class.
 *
...
class JK_Sitemaps_Index {
	...
	/**
	 * JK_Sitemaps_Index constructor.
	 *
	 * @since 5.5.0
	 *
	 * @param JK_Sitemaps_Registry $registry Sitemap provider registry.
	 */
	public function __construct( JK_Sitemaps_Registry $registry ) {
	...
	public function get_index_url() {
		...
		return home_url( '/jk-sitemap.xml' );
	}
}
