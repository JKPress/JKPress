<?php
/**
 * Sitemaps: JK_Sitemaps_Renderer class
 *
...
class JK_Sitemaps_Renderer {
	...
	/**
	 * JK_Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/jk-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'jk_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/jk-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'jk_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	private function check_for_simple_xml_availability() {
		if ( ! class_exists( 'SimpleXMLElement' ) ) {
			...
			jk_die(
				...
				esc_xml( __( 'JKPress &rsaquo; Error' ) ),
				array(
