<?php
/**
 * Sitemaps: JK_Sitemaps_Stylesheet class
 *
...
class JK_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by JKPress to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
...
XSL;
		 ...
		 */
		return apply_filters( 'jk_sitemaps_stylesheet_content', $xsl_content );
	}
...
XSL;
		 ...
		 * @param string $xsl_content Full content for the XML stylesheet.
		 */
		return apply_filters( 'jk_sitemaps_stylesheet_index_content', $xsl_content );
	}
...
EOF;
		 ...
		 */
		return apply_filters( 'jk_sitemaps_stylesheet_css', $css );
	}
}
