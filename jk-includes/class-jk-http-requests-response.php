<?php
/**
 * HTTP API: JK_HTTP_Requests_Response class
 *
 * @package JKPress
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see JK_HTTP_Response
 */
class JK_HTTP_Requests_Response extends JK_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return JK_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new JK_Http_Cookie(
				array(
					'name'      => $cookie->name,
	...
	/**
	 * Converts the object to a JK_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array JK_Http response array, per JK_Http::request().
	 */
