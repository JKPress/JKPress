<?php
/**
 * Style Engine: JK_Style_Engine_CSS_Declarations class
 *
 * @package JKPress
...
class JK_Style_Engine_CSS_Declarations {
	 ...
	 * @return JK_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
	 */
	...
	protected static function filter_declaration( $property, $value, $spacer = '' ) {
		$filtered_value = jk_strip_all_tags( $value, true );
		if ( '' !== $filtered_value ) {
