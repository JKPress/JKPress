<?php
/**
 * Style Engine: JK_Style_Engine_CSS_Rules_Store class
 *
 * @package JKPress
...
/**
 * Core class used as a store for JK_Style_Engine_CSS_Rule objects.
 *
...
class JK_Style_Engine_CSS_Rules_Store {

	/**
	 * An array of named JK_Style_Engine_CSS_Rules_Store objects.
	 *
	 * @static
	 *
	 * @since 6.1.0
	 ...
	 * @return JK_Style_Engine_CSS_Rules_Store|void
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return JK_Style_Engine_CSS_Rules_Store[]
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return JK_Style_Engine_CSS_Rule[]
	 */
	...
	/**
	 * Gets a JK_Style_Engine_CSS_Rule object by its selector.
	 ...
	 * @return JK_Style_Engine_CSS_Rule|void Returns a JK_Style_Engine_CSS_Rule object,
	...
	public function add_rule( $selector, $rules_group = '' ) {
		...
		if ( ! empty( $rules_group ) ) {
			if ( empty( $this->rules[ "$rules_group $selector" ] ) ) {
				$this->rules[ "$rules_group $selector" ] = new JK_Style_Engine_CSS_Rule( $selector, array(), $rules_group );
			}
		...
		if ( empty( $this->rules[ $selector ] ) ) {
			$this->rules[ $selector ] = new JK_Style_Engine_CSS_Rule( $selector );
		}
