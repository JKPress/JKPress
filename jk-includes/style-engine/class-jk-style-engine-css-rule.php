<?php
/**
 * Style Engine: JK_Style_Engine_CSS_Rule class
 *
 * @package JKPress
...
class JK_Style_Engine_CSS_Rule {
	 ...
	 *
	 * Contains a JK_Style_Engine_CSS_Declarations object.
	 *
	 * @since 6.1.0
	 * @var JK_Style_Engine_CSS_Declarations
	 */
	 ...
	 * @param string[]|JK_Style_Engine_CSS_Declarations $declarations Optional. An associative array of CSS definitions,
	 *                                                                e.g. `array( "$property" => "$value", "$property" => "$value" )`,
	 *                                                                or a JK_Style_Engine_CSS_Declarations object.
	 *                                                                Default empty array.
	 ...
	 * @return JK_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @param string[]|JK_Style_Engine_CSS_Declarations $declarations An array of declarations (property => value pairs),
	 *                                                                or a JK_Style_Engine_CSS_Declarations object.
	 * @return JK_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
	 */
	public function add_declarations( $declarations ) {
		...
		if ( null === $this->declarations ) {
			...
			$this->declarations = new JK_Style_Engine_CSS_Declarations( $declarations_array );
		}
	 ...
	 * @since 6.1.0
	 *
	 * @return JK_Style_Engine_CSS_Declarations The declarations object.
	 */
