 ...
 * to `jk_readonly()` in JKPress 5.9.0.
 *
 ...
 *
 * @since 4.9.0
 * @deprecated 5.9.0 Use jk_readonly() introduced in 5.9.0.
 *
 * @see jk_readonly()
 *
...
function readonly( $readonly_value, $current = true, $display = true ) {
	_deprecated_function( __FUNCTION__, '5.9.0', 'jk_readonly()' );
	return jk_readonly( $readonly_value, $current, $display );
}
