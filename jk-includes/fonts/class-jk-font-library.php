...
class JK_Font_Library {
	 ...
	 * @return JK_Font_Collection|JK_Error A font collection if it was registered successfully,
	 *                                     or JK_Error object on failure.
	 */
	public function register_font_collection( string $slug, array $args ) {
		$new_collection = new JK_Font_Collection( $slug, $args );
		...
		if ( $this->is_collection_registered( $new_collection->slug ) ) {
			...
			return new JK_Error( 'font_collection_registration_error', $error_message );
		}
	 ...
	 *
	 * @param string $slug Font collection slug.
	 * @return JK_Font_Collection|null Font collection object, or null if the font collection doesn't exist.
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @return JK_Font_Library The main instance.
	 */
