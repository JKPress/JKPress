<?php
/**
 * Feed API: JK_Feed_Cache_Transient class
 *
 * @package JKPress
 * @subpackage Feed
 * @since 4.7.0
...
class JK_Feed_Cache_Transient implements SimplePie\Cache\Base {
	...
	public function __construct( $location, $name, $type ) {
		 ...
		 */
		$this->lifetime = apply_filters( 'jk_feed_cache_transient_lifetime', $lifetime, $name );
	}
