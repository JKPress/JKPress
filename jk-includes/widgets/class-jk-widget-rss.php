<?php
/**
 * Widget API: JK_Widget_RSS class
 *
 * @package JKPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see JK_Widget
 */
class JK_Widget_RSS extends JK_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			$feed_link = sprintf(
				...
				esc_url( $feed_icon ),
				esc_attr__( 'RSS' ),
				( jk_lazy_loading_enabled( 'img', 'rss_widget_feed_icon' ) ? ' loading="lazy"' : '' )
			);
		...
		jk_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return jk_widget_rss_process( $new_instance, $testurl );
	}
