<?php
/**
 * Widget API: JK_Widget_Recent_Comments class
 *
 * @package JKPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see JK_Widget
 */
class JK_Widget_Recent_Comments extends JK_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'jk_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see JK_Comment_Query::query() for information on accepted arguments.
			 *
