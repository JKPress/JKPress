<?php
/**
 * Widget API: JK_Widget_Block class
 *
 * @package JKPress
 * @subpackage Widgets
 * @since 5.8.0
 ...
 * @see JK_Widget
 */
class JK_Widget_Block extends JK_Widget {
	...
	public function widget( $args, $instance ) {
		$instance = jk_parse_args( $instance, $this->default_instance );
		 ...
		 * @param JK_Widget_Block $widget   Current Block widget instance.
		 */
		echo apply_filters(
