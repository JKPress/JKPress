<?php
/**
 * Widget API: JK_Widget_Text class
 *
 * @package JKPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see JK_Widget
 */
class JK_Widget_Text extends JK_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'JK_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `JK_Widget_Custom_HTML` object in addition to a `JK_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param JK_Widget_Text|JK_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param JK_Widget_Text $widget   Current Text widget instance.
			 */
	 ...
	 * @since 4.9.0
	 *
	 * @see JK_Widget_Media_Video::inject_video_max_width_style()
	 *
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['text'] = jk_kses_post( $new_instance['text'] );
		}
	...
	public function enqueue_preview_scripts() {
		...
		jk_playlist_scripts( 'audio' );
		jk_playlist_scripts( 'video' );
	}
	...
	public function enqueue_admin_scripts() {
		jk_enqueue_editor();
		jk_enqueue_media();
		jk_enqueue_script( 'text-widgets' );
		jk_add_inline_script( 'text-widgets', sprintf( 'jk.textWidgets.idBases.push( %s );', jk_json_encode( $this->id_base ) ) );
		jk_add_inline_script( 'text-widgets', 'jk.textWidgets.init();', 'after' );
	}
	 ...
	 *
	 * @see JK_Widget_Text::render_control_template_scripts()
	...
	public static function render_control_template_scripts() {
		...
		<script type="text/html" id="tmpl-widget-text-control-fields">
			...
			<?php if ( ! in_array( 'text_widget_custom_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="jk-pointer custom-html-widget-pointer jk-pointer-top">
					<div class="jk-pointer-content">
						...
						<?php endif; ?>
						<div class="jk-pointer-buttons">
							<a class="close" href="#"><?php _e( 'Dismiss' ); ?></a>
						</div>
					</div>
					<div class="jk-pointer-arrow">
						<div class="jk-pointer-arrow-inner"></div>
					</div>
				</div>
			<?php endif; ?>

			<?php if ( ! in_array( 'text_widget_paste_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="jk-pointer paste-html-pointer jk-pointer-top">
					<div class="jk-pointer-content">
			...
			<p>
				...
				<textarea id="{{ elementIdPrefix }}text" class="widefat text jk-editor-area" style="height: 200px" rows="16" cols="20"></textarea>
			</p>
		</script>
		<?php
	}
