 ...
 * {@see 'jk_robots'} filter. The directives are then sanitized, and the
...
function jk_robots() {
	 ...
	 */
	$robots = apply_filters( 'jk_robots', array() );
 ...
 * {@see 'jk_robots'} filter.
 *
 * Typical usage is as a {@see 'jk_robots'} callback:
 *
 *     add_filter( 'jk_robots', 'jk_robots_noindex' );
 *
 * @since 5.7.0
 *
 * @see jk_robots_no_robots()
 *
 * @param array $robots Associative array of robots directives.
 * @return array Filtered robots directives.
 */
function jk_robots_noindex( array $robots ) {
	if ( ! get_option( 'blog_public' ) ) {
		return jk_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function jk_robots_noindex_embeds( array $robots ) {
	if ( is_embed() ) {
		return jk_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function jk_robots_noindex_search( array $robots ) {
	if ( is_search() ) {
		return jk_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function jk_robots_no_robots( array $robots ) {
	$robots['noindex'] = true;
 ...
 * @return array Filtered robots directives.
 */
function jk_robots_sensitive_page( array $robots ) {
	$robots['noindex']   = true;
 ...
 * @return array Filtered robots directives.
 */
function jk_robots_max_image_preview_large( array $robots ) {
	if ( get_option( 'blog_public' ) ) {
