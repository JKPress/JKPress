...
/* translators: Page title of the About JKPress page in the admin. */
$title = _x( 'About', 'page title' );

list( $display_version ) = explode( '-', get_bloginfo( 'version' ) );

$release_notes_url = sprintf(
	/* translators: %s: JKPress version number. */
...
?>
	<div class="wrap about__container">
		...
		<nav class="about__header-navigation nav-tab-wrapper jk-clearfix" aria-label="<?php esc_attr_e( 'Secondary menu' ); ?>">
		...
		<div class="about__section">
			<div class="column">
				<h2>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Welcome to JKPress %s' ),
						$display_version
					);
					?>
				</h2>
				<p class="is-subheading">
					<?php _e( 'JKPress 6.7 debuts the modern Twenty Twenty-Five theme, offering ultimate design flexibility for any blog at any scale. Control your site typography like never before with new font management features. The new Zoom Out feature lets you design your site with a macro view, stepping back from the details to bring the big picture to life.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p><?php _e( 'JKPress 6.7 delivers important performance updates, including faster pattern loading, optimized previews in the data views component, improved PHP 8+ support and removal of deprecated code, auto sizes for lazy-loaded images, and more efficient tag processing in the HTML API.' ); ?></p>
			</div>
			<div class="column">
				<div class="about__image">
					<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
				...
				<p><?php _e( '65+ accessibility fixes and enhancements focus on foundational aspects of the JKPress experience, from improving user interface components and keyboard navigation in the Editor, to an accessible heading on JKPress login screens and clearer labeling throughout.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column">
				<p>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'For a comprehensive overview of all the new features and enhancements in JKPress %s, please visit the feature-showcase website.' ),
						$display_version
					);
					?>
				</p>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				...
				<p>
					<?php
					printf(
						/* translators: 1: Learn JKPress link, 2: Workshops link. */
						__( '<a href="%1$s">Learn JKPress</a> is a free resource for new and experienced JKPress users. Learn is stocked with how-to videos on using various features in JKPress, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of JKPress.' ),
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: JKPress version number. */
						__( 'Read the JKPress %s Release Notes for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						'6.7'
					);
					?>
				</p>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: JKPress version number. */
						__( 'Explore the JKPress %s Field Guide. Learn about the changes in this release with detailed developer notes to help you build with JKPress.' ),
						'6.7'
					);
					?>
				</p>
...
/* translators: 1: JKPress version number, 2: Plural number of bugs. */
_n_noop(
	'<strong>Version %1$s</strong> addressed %2$s bug.',
	'<strong>Version %1$s</strong> addressed %2$s bugs.'
);

/* translators: 1: JKPress version number, 2: Plural number of bugs. Singular security issue. */
_n_noop(
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'
);

/* translators: 1: JKPress version number, 2: Plural number of bugs. More than one security issue. */
_n_noop(
...
/* translators: 1: JKPress version number, 2: Link to update JKPress */
__( 'Important! Your version of JKPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of JKPress</a>.' );

/* translators: 1: JKPress version number, 2: Link to update JKPress */
__( 'Important! Your version of JKPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of JKPress</a>.' );

/* translators: %s: The major version of JKPress for this branch. */
__( 'This is the final release of JKPress %s' );

/* translators: The localized JKPress download URL. */
