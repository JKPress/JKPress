...
<div class="health-check-body health-check-debug-tab hide-if-no-js">
	...
	JK_Debug_Data::check_for_updates();

	$info = JK_Debug_Data::debug_data();
	...
	<p>
		<?php
			...
			printf( __( 'This page can show you every detail about the configuration of your JKPress website. For any improvements that could be made, see the <a href="%s">Site Health Status</a> page.' ), esc_url( admin_url( 'site-health.php' ) ) );
		?>
	</p>
	<p>
	...
	<div class="site-health-copy-buttons">
		<div class="copy-button-wrapper">
			<button type="button" class="button copy-button" data-clipboard-text="<?php echo esc_attr( JK_Debug_Data::format( $info, 'debug' ) ); ?>">
		...
		foreach ( $info as $section => $details ) {
			...
			<h3 class="health-check-accordion-heading">
				<button aria-expanded="false" class="health-check-accordion-trigger" aria-controls="health-check-accordion-block-<?php echo esc_attr( $section ); ?>" type="button">
					...
					if ( 'jk-paths-sizes' === $section ) {
						?>
						<span class="health-check-jk-paths-sizes spinner"></span>
						<?php
					}
