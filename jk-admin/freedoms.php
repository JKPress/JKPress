...
if ( isset( $_GET['privacy-notice'] ) ) {
	jk_redirect( admin_url( 'privacy.php' ), 301 );
	exit;
}
...
<div class="wrap about__container">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			<?php _e( 'JKPress is free and open source software' ); ?>
		</div>
	</div>
	...
	<div class="about__section is-feature">
		...
		printf(
			...
			__( 'JKPress comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ),
	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			printf(
				...
				__( 'Every plugin and theme in JKPress.org&#8217;s directory is 100%% GPL or a similarly free and compatible license, so you can feel safe finding <a href="%1$s">plugins</a> and <a href="%2$s">themes</a> there. If you get a plugin or theme from another source, make sure to <a href="%3$s">ask them if it&#8217;s GPL</a> first. If they do not respect the JKPress license, it is not recommended to use them.' ),
				$plugins_url,
				$themes_url,
				__( 'https://wordpress.org/about/license/' )
			);
