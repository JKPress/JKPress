 ...
 *
 * @since 2.6.0
 * @output jk-admin/js/word-count.js
 */
...
( function() {
	 ...
	 *
	 * @namespace jk.utils.wordcounter
	 * @memberof  jk.utils
	 *
	 * @class
	 *
	...
	// Add the WordCounter to the JK Utils.
	window.jk = window.jk || {};
	window.jk.utils = window.jk.utils || {};
	window.jk.utils.WordCounter = WordCounter;
} )();
