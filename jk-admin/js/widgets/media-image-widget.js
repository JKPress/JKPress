/**
 * @output jk-admin/js/widgets/media-image-widget.js
 */
...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See JK_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @class    jk.mediaWidgets.modelConstructors.media_image
	 ...
	 */
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends jk.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = jk.template( 'jk-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = jk.template( 'jk-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			jk.media.model.Attachment.prototype.sync = function rejectedSync() {
