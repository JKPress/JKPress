/**
 * @output jk-admin/js/widgets/custom-html-widgets.js
 */
...
/**
 * @namespace jk.customHtmlWidget
 * @memberOf jk
 */
jk.customHtmlWidgets = ( function( $ ) {
	'use strict';
	...
	component.CustomHtmlWidgetControl = Backbone.View.extend(/** @lends jk.customHtmlWidgets.CustomHtmlWidgetControl.prototype */{
		 ...
		 * Text widget control.
		 *
		 * @constructs jk.customHtmlWidgets.CustomHtmlWidgetControl
		...
		initialize: function initialize( options ) {
			...
			control.$el.html( jk.template( 'widget-custom-html-control-fields' )( { codeEditorDisabled: component.codeEditorSettings.disabled } ) );
		...
		updateErrorNotice: function( errorAnnotations ) {
			...
			if ( jk.customize && jk.customize.has( control.customizeSettingId ) ) {
				customizeSetting = jk.customize( control.customizeSettingId );
				customizeSetting.notifications.remove( 'htmlhint_error' );
				if ( 0 !== errorAnnotations.length ) {
					customizeSetting.notifications.add( 'htmlhint_error', new jk.customize.Notification( 'htmlhint_error', {
						message: message,
						type: 'error'
					} ) );
				}
		...
		initializeEditor: function initializeEditor() {
			...
			control.editor = jk.codeEditor.initialize( control.fields.content, settings );
	 ...
	 *
	 * @alias jk.customHtmlWidgets.widgetControls
	 *
	 * @type {Object.<string, jk.textWidgets.CustomHtmlWidgetControl>}
	 */
	 ...
	 *
	 * @alias jk.customHtmlWidgets.handleWidgetAdded
	 *
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		renderWhenAnimationDone = function() {
			if ( ! ( jk.customize ? widgetContainer.parent().hasClass( 'expanded' ) : widgetContainer.hasClass( 'open' ) ) ) { // Core merge: The jk.customize condition can be eliminated with this change being in core: https://github.com/xwp/wordpress-develop/pull/247/commits/5322387d
	 ...
	 *
	 * @alias jk.customHtmlWidgets.setupAccessibleMode
	 *
	 * @return {void}
	 */
	 ...
	 *
	 * @alias jk.customHtmlWidgets.handleWidgetUpdated
	 *
	 * @param {jQuery.Event} event - Event.
	 * @param {jQuery}       widgetContainer - Widget container element.
	 * @return {void}
	 ...
	 *
	 * @alias jk.customHtmlWidgets.init
	 *
