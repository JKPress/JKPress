/**
 * @output jk-admin/js/widgets/media-gallery-widget.js
 */
...
(function( component ) {
	 ...
	 *
	 * @since 4.9.0
	 * @class    jk.mediaWidgets~GalleryDetailsMediaFrame
	 * @augments jk.media.view.MediaFrame.Post
	 */
	GalleryDetailsMediaFrame = jk.media.view.MediaFrame.Post.extend(/** @lends jk.mediaWidgets~GalleryDetailsMediaFrame.prototype */{
	 ...
	 *
	 * See JK_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @since 4.9.0
	 *
	 * @class    jk.mediaWidgets.modelConstructors.media_gallery
	 * @augments jk.mediaWidgets.MediaWidgetModel
	 */
	GalleryWidgetModel = component.MediaWidgetModel.extend(/** @lends jk.mediaWidgets.modelConstructors.media_gallery.prototype */{} );

	GalleryWidgetControl = component.MediaWidgetControl.extend(/** @lends jk.mediaWidgets.controlConstructors.media_gallery.prototype */{
		 ...
		 * See JK_Widget_Gallery::enqueue_admin_scripts() for amending prototype from PHP exports.
		 *
		 * @constructs jk.mediaWidgets.controlConstructors.media_gallery
		...
		initialize: function initialize( options ) {
			...
			control.selectedAttachments = new jk.media.model.Attachments();
			 ...
			 */
			if ( jk.customize && jk.customize.previewer ) {
				control.selectedAttachments.on( 'change', function() {
					jk.customize.previewer.send( 'refresh-widget-partial', control.model.get( 'widget_id' ) );
				} );
			}
		},
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = jk.template( 'jk-media-widget-gallery-preview' );
		...
		editMedia: function editMedia() {
			...
			selection = new jk.media.model.Selection( control.selectedAttachments.models, {
				multiple: true
			});
		 ...
		 *
		 * @since 4.9.0
		 * @param {jk.media.models.Attachment} attachment - Attachment.
		 * @return {void}
		 */
