/**
 * @output jk-admin/js/password-strength-meter.js
 */
...
(function($){
		...
		userInputBlacklist : function() {
			window.console.log(
				sprintf(
					...
					'jk.passwordStrength.userInputBlacklist()',
					'5.5.0',
					'jk.passwordStrength.userInputDisallowedList()'
				)
			);

			return jk.passwordStrength.userInputDisallowedList();
		},
	 ...
	 *
	 * @since 2.5.0
	 * @deprecated 3.7.0 Use jk.passwordStrength.meter instead.
	 *
	 * @global
	 *
	 * @type {jk.passwordStrength.meter}
	 */
	window.passwordStrength = jk.passwordStrength.meter;
})(jQuery);
