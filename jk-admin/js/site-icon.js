 ...
 *
 * @since 6.5.0
 * @output jk-admin/js/site-icon.js
 */
...
( function ( $ ) {
	...
	function switchToUpdate( attributes ) {
		...
		if ( attributes.alt ) {
			i18nAppAlternativeString = jk.i18n.sprintf(
				/* translators: %s: The selected image alt text. */
				jk.i18n.__( 'App icon preview: Current image: %s' ),
				attributes.alt
			);
			i18nBrowserAlternativeString = jk.i18n.sprintf(
				/* translators: %s: The selected image alt text. */
				jk.i18n.__( 'Browser icon preview: Current image: %s' ),
				attributes.alt
			);
		} else {
			i18nAppAlternativeString = jk.i18n.sprintf(
