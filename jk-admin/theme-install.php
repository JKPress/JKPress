...
require ABSPATH . 'jk-admin/includes/theme-install.php';

$tab = ! empty( $_REQUEST['tab'] ) ? sanitize_text_field( $_REQUEST['tab'] ) : '';

if ( ! current_user_can( 'install_themes' ) ) {
	jk_die( __( 'Sorry, you are not allowed to install themes on this site.' ) );
}

if ( is_multisite() && ! is_network_admin() ) {
	jk_redirect( network_admin_url( 'theme-install.php' ) );
	exit;
}
...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">JKPress Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license JKPress uses.' ),
	...
	'<p>' . sprintf(
		/* translators: %s: /jk-content/themes */
...
<div class="wrap">
	...
	<div class="jk-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on JKPress.org, you can browse them here.' ); ?></p>

			<p class="favorites-username">
				<label for="wporg-username-input"><?php _e( 'Your JKPress.org username:' ); ?></label>
	...
	<div class="theme-install-overlay jk-full-overlay expanded"></div>
...
<script id="tmpl-theme" type="text/template">
	...
	<# if ( ! data.compatible_jk || ! data.compatible_php ) { #>
...
<script id="tmpl-theme-preview" type="text/template">
	<div class="jk-full-overlay-sidebar">
		<div class="jk-full-overlay-header">
		...
		<div class="jk-full-overlay-sidebar-content">
			...
			<div class="jk-full-overlay-footer">
		...
		<div class="jk-full-overlay-main">
