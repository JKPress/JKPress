...
/**
 * Theme Upgrader Skin for JKPress Theme Upgrades.
 *
 * @since 2.8.0
 ...
 */
class Theme_Upgrader_Skin extends JK_Upgrader_Skin {
	...
	public function after() {
		...
		if ( $theme_info ) {
			...
			if ( ! $this->result || is_jk_error( $this->result ) || is_network_admin() ) {
