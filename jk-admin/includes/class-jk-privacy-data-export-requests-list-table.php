<?php
/**
 * List Table API: JK_Privacy_Data_Export_Requests_List_Table class
 *
 * @package JKPress
...
/**
 * JK_Privacy_Data_Export_Requests_Table class.
 *
 * @since 4.9.6
 */
class JK_Privacy_Data_Export_Requests_List_Table extends JK_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		$status          = $item->status;
		$request_id      = $item->ID;
		$nonce           = jk_create_nonce( 'jk-privacy-export-personal-data-' . $request_id );
