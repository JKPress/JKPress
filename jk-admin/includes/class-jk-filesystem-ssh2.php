<?php
/**
 * JKPress Filesystem Class for implementing SSH2
 *
 ...
 *
 * Note: As of JKPress 2.8, this utilizes the PHP5+ function `stream_get_contents()`.
 *
 * @since 2.7.0
 *
 * @package JKPress
 ...
 */
class JK_Filesystem_SSH2 extends JK_Filesystem_Base {
