...
// Media hooks.
add_filter( 'jk_handle_upload_prefilter', 'check_upload_size' );
...
// Network hooks.
add_action( 'update_site_option_admin_email', 'jk_network_admin_email_change_notification', 10, 4 );

// Post hooks.
add_filter( 'jk_insert_post_data', 'avoid_blog_page_permalink_collision', 10, 2 );
