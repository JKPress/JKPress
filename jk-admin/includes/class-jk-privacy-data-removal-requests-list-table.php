<?php
/**
 * List Table API: JK_Privacy_Data_Removal_Requests_List_Table class
 *
 * @package JKPress
...
if ( ! class_exists( 'JK_Privacy_Requests_Table' ) ) {
	require_once ABSPATH . 'jk-admin/includes/class-jk-privacy-requests-table.php';
}

/**
 * JK_Privacy_Data_Removal_Requests_List_Table class.
 *
 * @since 4.9.6
 */
class JK_Privacy_Data_Removal_Requests_List_Table extends JK_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		if ( 'request-confirmed' !== $status ) {
			...
			$nonce         = jk_create_nonce( 'jk-privacy-erase-personal-data-' . $request_id );
