<?php
/**
 * JKPress FTP Sockets Filesystem.
 *
 * @package JKPress
...
/**
 * JKPress Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 *
 * @see JK_Filesystem_Base
 */
class JK_Filesystem_ftpsockets extends JK_Filesystem_Base {
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! require_once ABSPATH . 'jk-admin/includes/class-ftp.php' ) {
			return;
		}
