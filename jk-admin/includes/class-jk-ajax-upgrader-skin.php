<?php
/**
 * Upgrader API: JK_Ajax_Upgrader_Skin class
 *
 * @package JKPress
 * @subpackage Upgrader
 * @since 4.6.0
...
/**
 * Upgrader Skin for Ajax JKPress upgrades.
 *
 ...
 */
class JK_Ajax_Upgrader_Skin extends Automatic_Upgrader_Skin {
	 ...
	 * which in turn calls the jk_get_theme() function.
	 *
	 * @var JK_Theme|false The theme's info object, or false.
	 */
	public $theme_info = false;

	/**
	 * Holds the JK_Error object.
	 *
	 * @since 4.6.0
	 *
	 * @var null|JK_Error
	 ...
	 * Constructor.
	 *
	 * Sets up the JKPress Ajax upgrader skin.
	 *
	 * @since 4.6.0
	 *
	 * @see JK_Upgrader_Skin::__construct()
	 *
	 * @param array $args Optional. The JKPress Ajax upgrader skin arguments to
	 *                    override default options. See JK_Upgrader_Skin::__construct().
	 *                    Default empty array.
	 */
	 ...
	 * @since 4.6.0
	 *
	 * @return JK_Error Errors during an upgrade.
	 */
	 ...
	 *
	 * @param string|array|JK_Error $feedback Message data.
	 * @param mixed                 ...$args  Optional text replacements.
	 */
	public function feedback( $feedback, ...$args ) {
		if ( is_jk_error( $feedback ) ) {
