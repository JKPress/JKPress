...
/**
 * Sets up the JKPress core custom header and custom background features.
 *
 * @since Twenty Sixteen 1.0
 *
...
function twentysixteen_custom_header_and_background() {
	...
	add_theme_support(
		 ...
		 *     @type callable $jk-head-callback   Callback function used to style the header image and text
		...
		apply_filters(
			...
			array(
				...
				'height'             => 280,
				'flex-height'        => true,
				'jk-head-callback'   => 'twentysixteen_header_style',
			)
		)
	);
}
 ...
 * @since Twenty Sixteen 1.0
 *
 * @param JK_Customize_Manager $jk_customize The Customizer object.
 */
function twentysixteen_customize_register( $jk_customize ) {
	$color_scheme = twentysixteen_get_color_scheme();
	...
	$jk_customize->remove_control( 'header_textcolor' );
...
function twentysixteen_color_scheme_css() {
	...
	jk_add_inline_style( 'twentysixteen-style', $color_scheme_css );
}
add_action( 'jk_enqueue_scripts', 'twentysixteen_color_scheme_css' );
...
function twentysixteen_customize_control_js() {
	jk_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'jk-util' ), '20170530', array( 'in_footer' => true ) );
	jk_localize_script( 'color-scheme-control', 'colorScheme', twentysixteen_get_color_schemes() );
}
...
function twentysixteen_customize_preview_js() {
	jk_enqueue_script( 'twentysixteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20170530', array( 'in_footer' => true ) );
}
...
function twentysixteen_page_background_color_css() {
	...
	jk_add_inline_style( 'twentysixteen-style', sprintf( $css, $page_background_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentysixteen_page_background_color_css', 11 );
...
function twentysixteen_link_color_css() {
	...
	jk_add_inline_style( 'twentysixteen-style', sprintf( $css, $link_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentysixteen_link_color_css', 11 );
...
function twentysixteen_main_text_color_css() {
	...
	jk_add_inline_style( 'twentysixteen-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentysixteen_main_text_color_css', 11 );
...
function twentysixteen_secondary_text_color_css() {
	...
	jk_add_inline_style( 'twentysixteen-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentysixteen_secondary_text_color_css', 11 );
