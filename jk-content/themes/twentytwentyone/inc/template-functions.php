<?php
/**
 * Functions which enhance the theme by hooking into JKPress
 *
 * @package JKPress
...
add_action( 'jk_head', 'twenty_twenty_one_pingback_header' );
...
add_action( 'jk_footer', 'twenty_twenty_one_supports_js' );
...
function twenty_twenty_one_get_non_latin_css( $type = 'front-end' ) {
	...
	$elements = apply_filters(
		...
		array(
			'front-end'      => array( 'body', 'input', 'textarea', 'button', '.button', '.faux-button', '.jk-block-button__link', '.jk-block-file__button', '.has-drop-cap:not(:focus)::first-letter', '.entry-content .jk-block-archives', '.entry-content .jk-block-categories', '.entry-content .jk-block-cover-image', '.entry-content .jk-block-latest-comments', '.entry-content .jk-block-latest-posts', '.entry-content .jk-block-pullquote', '.entry-content .jk-block-quote.is-large', '.entry-content .jk-block-quote.is-style-large', '.entry-content .jk-block-archives *', '.entry-content .jk-block-categories *', '.entry-content .jk-block-latest-posts *', '.entry-content .jk-block-latest-comments *', '.entry-content p', '.entry-content ol', '.entry-content ul', '.entry-content dl', '.entry-content dt', '.entry-content cite', '.entry-content figcaption', '.entry-content .jk-caption-text', '.comment-content p', '.comment-content ol', '.comment-content ul', '.comment-content dl', '.comment-content dt', '.comment-content cite', '.comment-content figcaption', '.comment-content .jk-caption-text', '.widget_text p', '.widget_text ol', '.widget_text ul', '.widget_text dl', '.widget_text dt', '.widget-content .rssSummary', '.widget-content cite', '.widget-content figcaption', '.widget-content .jk-caption-text' ),
			'block-editor'   => array( '.editor-styles-wrapper > *', '.editor-styles-wrapper p', '.editor-styles-wrapper ol', '.editor-styles-wrapper ul', '.editor-styles-wrapper dl', '.editor-styles-wrapper dt', '.editor-post-title__block .editor-post-title__input', '.editor-styles-wrapper .jk-block h1', '.editor-styles-wrapper .jk-block h2', '.editor-styles-wrapper .jk-block h3', '.editor-styles-wrapper .jk-block h4', '.editor-styles-wrapper .jk-block h5', '.editor-styles-wrapper .jk-block h6', '.editor-styles-wrapper .has-drop-cap:not(:focus)::first-letter', '.editor-styles-wrapper cite', '.editor-styles-wrapper figcaption', '.editor-styles-wrapper .jk-caption-text' ),
	...
	if ( ! function_exists( 'twenty_twenty_one_generate_css' ) ) {
		require_once get_theme_file_path( 'inc/custom-css.php' ); // phpcs:ignore JKThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
	}
...
function twenty_twenty_one_print_first_instance_of_block( $block_name, $content = null, $instances = 1 ) {
	...
	if ( $blocks_content ) {
		...
		echo apply_filters( 'the_content', $blocks_content ); // phpcs:ignore JKPress.Security.EscapeOutput
		return true;
	}
...
function twenty_twenty_one_password_form( $output, $post = 0 ) {
	$post   = get_post( $post );
	$label  = 'pwbox-' . ( empty( $post->ID ) ? jk_rand() : $post->ID );
	...
	<form action="' . esc_url( site_url( 'jk-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form" method="post">
...
add_filter( 'jk_get_attachment_image_attributes', 'twenty_twenty_one_get_attachment_image_attributes', 10, 3 );
