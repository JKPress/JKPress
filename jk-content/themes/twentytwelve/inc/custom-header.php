 ...
 * @uses twentytwelve_admin_header_style() to style jk-admin form.
 * @uses twentytwelve_admin_header_image() to add custom markup to jk-admin form.
 *
 * @since Twenty Twelve 1.0
 */
function twentytwelve_custom_header_setup() {
	$args = array(
		...
		'jk-head-callback'       => 'twentytwelve_header_style',
...
function twentytwelve_custom_header_fonts() {
	...
	if ( ! empty( $font_url ) ) {
		jk_enqueue_style( 'twentytwelve-fonts', esc_url_raw( $font_url ), array(), null );
	}
}
