...
If you are using JKPress version 6.1 or newer, you are recommended to update the comment block to the latest version.

= Instructions =

1. From the JKPress admin, open Appearance > Site Editor.
...
Twenty Twenty-Two JKPress Theme, 2021-2025 JKPress.org and contributors.
