...
(function( $ ) {
	...
	jk.customize.bind( 'preview-ready', function() {

		// Initially hide the theme option placeholders on load.
		$( '.panel-placeholder' ).hide();

		jk.customize.preview.bind( 'section-highlight', function( data ) {
	...
	// Color scheme.
	jk.customize( 'colorscheme', function( value ) {
		value.bind( function( to ) {
	...
	// Custom color hue.
	jk.customize( 'colorscheme_hue', function( value ) {
		value.bind( function( to ) {
	...
	// Page layouts.
	jk.customize( 'page_layout', function( value ) {
		value.bind( function( to ) {
			if ( 'one-column' === to ) {
	...
	function hasHeaderImage() {
		var image = jk.customize( 'header_image' )();
		return '' !== image && 'remove-header' !== image;
	}

	// Whether a header video is available.
	function hasHeaderVideo() {
		var externalVideo = jk.customize( 'external_header_video' )(),
			video = jk.customize( 'header_video' )();
	...
	$.each( [ 'external_header_video', 'header_image', 'header_video' ], function( index, settingId ) {
		jk.customize( settingId, function( setting ) {
