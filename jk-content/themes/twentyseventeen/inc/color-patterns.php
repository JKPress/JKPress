...
.colors-custom .site-content .jk-playlist-light .jk-playlist-current-item .jk-playlist-item-album {
...
.colors-custom .site-content .jk-playlist-light .jk-playlist-current-item .jk-playlist-item-artist {
...
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:hover,
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:focus {
...
.colors-custom .jk_widget_tag_cloud a:hover,
.colors-custom .jk_widget_tag_cloud a:focus {
...
.colors-custom .jk_widget_tag_cloud a {
...
.colors-custom .site-content .jk-playlist-light .jk-playlist-item,
.colors-custom tr {
	border-bottom-color: hsl( ' . $hue . ', ' . $saturation . ', 93% ); /* base: #eee; */
}

.colors-custom .site-content .jk-playlist-light {
...
.colors-custom .entry-footer .edit-link a.post-edit-link,
.colors-custom .social-navigation a,
.colors-custom .site-content .jk-playlist-light a.jk-playlist-caption:hover,
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:hover a,
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:focus a,
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:hover,
.colors-custom .site-content .jk-playlist-light .jk-playlist-item:focus,
.colors-custom .prev.page-numbers:focus,
.colors-custom .prev.page-numbers:hover,
