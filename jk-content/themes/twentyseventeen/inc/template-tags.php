...
if ( ! function_exists( 'twentyseventeen_entry_footer' ) ) :
	...
	function twentyseventeen_entry_footer() {
		...
		$separate_meta = jk_get_list_item_separator();
 ...
 *
 * @param JK_Customize_Partial $partial Partial associated with a selective refresh request.
 * @param int                  $id      Front page section to display.
 */
function twentyseventeen_front_page_section( $partial = null, $id = 0 ) {
	if ( $partial instanceof JK_Customize_Partial ) {
