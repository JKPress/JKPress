...
(function( $ ) {
	...
	// Primary color.
	jk.customize( 'primary_color', function( value ) {
		value.bind( function( to ) {
			...
			if( 'custom' === to ){
				...
				color = jk.customize.get().primary_color_hue;
			} else {
	...
	// Primary color hue.
	jk.customize( 'primary_color_hue', function( value ) {
		value.bind( function( to ) {
	...
	// Image filter.
	jk.customize( 'image_filter', function( value ) {
		value.bind( function( to ) {
			if ( to ) {
