...
add_action( 'jk_head', 'twentynineteen_pingback_header' );
...
add_filter( 'jk_get_attachment_image_attributes', 'twentynineteen_post_thumbnail_sizes_attr' );
...
add_filter( 'jk_nav_menu', 'twentynineteen_add_ellipses_to_nav', 10, 2 );
 ...
 * }
 * @param JK_Post $item The current menu item object.
...
add_filter( 'jk_nav_menu_objects', 'twentynineteen_add_mobile_parent_nav_menu_items', 10, 2 );
...
add_filter( 'jk_link_pages_link', 'twentynineteen_link_pages_link', 10, 2 );
