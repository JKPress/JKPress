...
/* Tell JKPress to run twentyten_setup() when the 'after_setup_theme' hook is run. */
...
/**
 * Show a home link for our jk_nav_menu() fallback, jk_page_menu().
 *
 * To override this in a child theme, remove the filter and optionally add
 * your own function tied to the jk_page_menu_args filter hook.
 *
 * @since Twenty Ten 1.0
 *
 * @param array $args An optional array of arguments. @see jk_page_menu()
 */
...
add_filter( 'jk_page_menu_args', 'twentyten_page_menu_args' );
 ...
 * a simple filter call that tells JKPress to not use the default styles.
 *
 ...
 *
 * @since Twenty Ten 1.0
 * @deprecated Deprecated in Twenty Ten 1.2 for JKPress 3.1
 *
...
// Backward compatibility with JKPress 3.0.
if ( version_compare( $GLOBALS['jk_version'], '3.1', '<' ) ) {
 ...
 *
 * This function uses a filter (show_recent_comments_widget_style) new in JKPress 3.1
 * to remove the default style. Using Twenty Ten 1.2 in JKPress 3.0 will show the styles,
...
function twentyten_scripts_styles() {
	...
	jk_enqueue_style( 'twentyten-block-style', get_template_directory_uri() . '/blocks.css', array(), '20240703' );
}
add_action( 'jk_enqueue_scripts', 'twentyten_scripts_styles' );
...
function twentyten_block_editor_styles() {
	// Block styles.
	jk_enqueue_style( 'twentyten-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', array(), '20240703' );
}
