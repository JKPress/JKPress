...
/**
 * Set up the JKPress core custom header arguments and settings.
 *
 * @uses add_theme_support() to register support for 3.4 and up.
 * @uses twentythirteen_header_style() to style front end.
 * @uses twentythirteen_admin_header_style() to style jk-admin form.
 * @uses twentythirteen_admin_header_image() to add custom markup to jk-admin form.
...
function twentythirteen_custom_header_setup() {
	$args = array(
		...
		'jk-head-callback'       => 'twentythirteen_header_style',
...
function twentythirteen_custom_header_fonts() {
	...
	jk_enqueue_style( 'twentythirteen-fonts', twentythirteen_fonts_url(), array(), null );
