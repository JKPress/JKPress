 ...
 * for various features in JKPress, such as post thumbnails, navigation menus, and the like.
 *
...
/*
 * Tell JKPress to run twentyeleven_setup() when the 'after_setup_theme' hook is run.
 */
...
if ( ! function_exists( 'twentyeleven_setup' ) ) :
	...
	function twentyeleven_setup() {
		...
		add_theme_support(
			...
			array(
				/*
				* Let JKPress know what our default background color is.
		...
		$custom_header_support = array(
			...
			'jk-head-callback'       => 'twentyeleven_header_style',
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			// This is all for compatibility with versions of JKPress prior to 3.4.
			define( 'HEADER_TEXTCOLOR', $custom_header_support['default-text-color'] );
			define( 'HEADER_IMAGE', '' );
			define( 'HEADER_IMAGE_WIDTH', $custom_header_support['width'] );
			define( 'HEADER_IMAGE_HEIGHT', $custom_header_support['height'] );
			add_custom_image_header( $custom_header_support['jk-head-callback'], $custom_header_support['admin-head-callback'], $custom_header_support['admin-preview-callback'] );
...
function twentyeleven_scripts_styles() {
	...
	jk_enqueue_style( 'twentyeleven-block-style', get_template_directory_uri() . '/blocks.css', array(), '20240703' );
}
add_action( 'jk_enqueue_scripts', 'twentyeleven_scripts_styles' );
...
function twentyeleven_block_editor_styles() {
	// Block styles.
	jk_enqueue_style( 'twentyeleven-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', array(), '20240716' );
}
...
if ( ! function_exists( 'twentyeleven_header_image' ) ) :
	...
	function twentyeleven_header_image() {
		...
		// Compatibility with versions of JKPress prior to 3.4.
		if ( function_exists( 'get_custom_header' ) ) {
...
/**
 * Show a home link for the jk_nav_menu() fallback, jk_page_menu().
 *
 * @since Twenty Eleven 1.0
 *
 * @param array $args The page menu arguments. @see jk_page_menu()
...
add_filter( 'jk_page_menu_args', 'twentyeleven_page_menu_args' );
...
add_action( 'jk_body_open', 'twentyeleven_skip_link', 5 );
