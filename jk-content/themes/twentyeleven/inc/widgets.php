 ...
 */
class Twenty_Eleven_Ephemera_Widget extends JK_Widget {
	...
	public function widget( $args, $instance ) {
		$cache = jk_cache_get( 'widget_twentyeleven_ephemera', 'widget' );
		...
		/** This filter is documented in jk-includes/default-widgets.php */
		...
		$ephemera      = new JK_Query( $ephemera_args );
		...
		if ( ! is_customize_preview() ) {
			jk_cache_set( 'widget_twentyeleven_ephemera', $cache, 'widget' );
		}
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$alloptions = jk_cache_get( 'alloptions', 'options' );
	...
	public function flush_widget_cache() {
		jk_cache_delete( 'widget_twentyeleven_ephemera', 'widget' );
	}

	/**
	 * Set up the widget form.
	 *
	 * Displays the form for this widget on the Widgets page of the JK Admin area.
	 *
	 * @since Twenty Eleven 1.0
	 *
