...
function twentyeleven_admin_enqueue_scripts( $hook_suffix ) {
	jk_enqueue_style( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.css', false, '20110602' );
	jk_enqueue_script( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.js', array( 'farbtastic' ), '20110610' );
	jk_enqueue_style( 'farbtastic' );
}
...
function twentyeleven_theme_options_render_page() {
	$theme_name = function_exists( 'jk_get_theme' ) ? jk_get_theme()->display( 'Name' ) : get_option( 'current_theme' );
	?>
	<div class="wrap">
		<h2>
		<?php
...
function twentyeleven_enqueue_color_scheme() {
	...
	if ( 'dark' === $color_scheme ) {
		jk_enqueue_style( 'dark', get_template_directory_uri() . '/colors/dark.css', array(), '20240603' );
	}
...
add_action( 'jk_enqueue_scripts', 'twentyeleven_enqueue_color_scheme' );

/**
 * Add a style block to the theme for the current link color.
 *
 * This function is attached to the jk_head action hook.
 *
 * @since Twenty Eleven 1.0
 */
...
add_action( 'jk_head', 'twentyeleven_print_link_color_style' );
 ...
 */
function twentyeleven_customize_register( $jk_customize ) {
...
function twentyeleven_customize_preview_js() {
	jk_enqueue_script( 'twentyeleven-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20150401', array( 'in_footer' => true ) );
}
