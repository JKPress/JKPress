...
/**
 * Set up the JKPress core custom header feature.
 *
...
function twentyfifteen_custom_header_setup() {
	...
	add_theme_support(
		 ...
		 *     @type string $jk-head-callback   Callback function used to styles the header image and text
		...
		apply_filters(
			...
			array(
				...
				'width'              => 954,
				'height'             => 1300,
				'jk-head-callback'   => 'twentyfifteen_header_style',
			)
		)
	);
}
...
function twentyfifteen_header_background_color_css() {
	...
	jk_add_inline_style( 'twentyfifteen-style', sprintf( $css, $header_background_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentyfifteen_header_background_color_css', 11 );
...
function twentyfifteen_sidebar_text_color_css() {
	...
	jk_add_inline_style( 'twentyfifteen-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'jk_enqueue_scripts', 'twentyfifteen_sidebar_text_color_css', 11 );
